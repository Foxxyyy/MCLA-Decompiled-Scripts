void main()
{
   ...
   var3 = mcHookman_GetState(L[0].v0.v97.v0);
   if (var3 == 4)
   {
       mcSlotSystem_RequestSlotRemoval(L[0].v0.v97.v0, 0);
       return;
   }
   else
   {
       ...
       PRINTSTRING("Local Hookman ");
       PRINTINT(var2);
       PRINTSTRING(" using ");
       PRINTSTRING(mcHookman_GetCarConfigName(L[0].v0.v97.v0));
       PRINTSTRING("\n");
       OpponentManager_AddOpponentToWorld(L[0].v0.v97.v1);
       var4 = Opponent_GetRacer(L[0].v0.v97.v1);
       Racer_SetUIDAndCharacterName(var4, var2, mcCareer_GetHookmanCharacterSet(mcHookman_GetName(L[0].v0.v97.v0)));
       mcTargetManager_RegisterRacer(var2, var4);
       Racer_SetModValue(var4, mcHookman_GetModValue(L[0].v0.v97.v0));
       Racer_InitializeResetPosition(var4, &(L[0].v0.v0[0 * 3]), L[0].v0.v95);
       Racer_Reset(var4);
       L[0].v0.v97.v2 = mcHudMapServer_CreateElement();
       mcHudMapServer_SetVehicleElement(L[0].v0.v97.v2, 3, var4);
       var5 = mcHookman_IsHidden(L[0].v0.v97.v0);
       if (!var5)
       {
           mcTargetManager_HideTarget(var2, 0);
       }
       Racer_SetIconType(var4, 4);
       var8 = 0;
       while (!var8)
       {
           var3 = mcHookman_GetState(L[0].v0.v97.v0);
           ...
           {
               var7 = mcHookman_GetDifficulty(L[0].v0.v97.v0);
               Racer_SetIconColorByDifficulty(var4, var7);
               var6 = START_NEW_SCRIPT_WITH_ARGS("game/CruisingHookmen/CruisingHookmanCore", &(L[0].v0), 103, 1500);
               while (!IsChildFinished(var6))
               {
                   WAITUNWARPED(100);
               }
               var3 = mcHookman_GetState(L[0].v0.v97.v0);
               ...
               {
                   L[0].v0.v101 = 1;
                   sub_41b(L[0].v0.v97.v1, 3, var7, L[0].v0.v97.v2, 1, 2, 6, 31, 255, 0, 0, 0);
                   var3 = mcHookman_GetState(L[0].v0.v97.v0);
                   if (var3 == 4)
                   {
                   }
       ...
       PRINTSTRING("Deleting Local Hookman -");
       PRINTINT(var2);
       PRINTSTRING("\n");
...
void sub_41b(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11)
{
   ...
   sub_b9d(&var14, var840, var0, 2, 1, 13, var10);
   var854 = 1;
   var855 = 0;
   var856 = 0;
   var857 = 0;
   ...
   sub_2a53(&var14);
   var14.v799 = sub_2b06(var840, var14.v4.v770, var854);
   ...
   {
       sub_2c56(var840, 0.0f, 0, 0, 1, 1, 1);
   }
   else
   {
       sub_2c56(var840, 0.25f, 0, 0, 1, 1, 1);
   }
   var856 = 0;
   if (var855)
   {
   ...
   {
       var853 = var852 + (var14.v4.v770 - var14.v4.v771);
       sub_421d(var14.v4.v1[0 * 48].v0, var14.v4.v1[var853 * 48].v1, var14.v4.v1[var853 * 48].v0, var853, Race_HasBeenArrested(var14.v3));
...
void sub_b9d(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_c55(0, 0x3f000000, 108);
           sub_ce8(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_d9d(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_10c5(var2);
...
function sub_ce8(var0, var1, var2, var3, var4)
{
...
void sub_17e6(var0, var1, var2, var3)
{
...
function sub_2b06(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2b44(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2b44(var0, var1, var2, var3, var4)
{
...
void sub_2c56(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_327d(var0, var1, var2, var3)
{
...
void sub_3614(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_421d(var0, var1, var2, var3, var4)
{
