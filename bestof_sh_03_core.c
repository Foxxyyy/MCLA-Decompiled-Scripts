void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("BESTOF_SH_03");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3c9(L[0].v0.v97.v1, mcHookman_GetDifficulty(L[0].v0.v97.v0));
   ...
   sub_88a(RAND_INT_RANGE(0, 7), var7);
...
void sub_3c9(var0, var1)
{
   ...
   var4.v814 = 1;
   var4.v802 = "BESTOF_SH_03_SERIES";
   var4.v803 = 3;
   var4.v813 = 2;
   var4.v804[0] = "game/Race/Hollywood/Ordered/hw_ordered_ds_03";
   var4.v804[1] = "game/Race/Hollywood/Ordered/_circuit_mb_04a";
   var4.v804[2] = "game/Race/Hollywood/Ordered/hw_ordered_dh_02c";
   var4.v0.v4.v770 = 2;
   var4.v0.v4.v771 = 0;
   var4.v0.v4.v775 = var1;
   var4.v0.v4.v1[0 * 48].v0 = sub_632(0);
   ...
   var4.v0.v4.v776 = 15;
   var4.v0.v4.v777 = 31;
   var4.v817 = "GREET_BESTOF_SH_03";
   var4.v818 = "TAUNT_PRE_BESTOF_SH_03";
   sub_767(&var4);
   Racer_SetStreamingUnlocked(var4.v0.v4.v1[1 * 48].v0);
}

function sub_632(var0)
{
   auto var3, var4;
