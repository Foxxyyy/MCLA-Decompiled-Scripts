void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("BESTOF_GH_22");
   var9 = 0;
   while (!var9)
   {
   ...
   sub_887(RAND_INT_RANGE(0, 7), var7);
...
void sub_3c9(var0, var1)
{
   ...
   var4.v814 = 1;
   var4.v802 = "BESTOF_GH_22_SERIES";
   var4.v803 = 3;
   var4.v813 = 2;
   var4.v804[0] = "game/Race/Downtown/Circuit/dt_circuit_mg_01";
   var4.v804[1] = "game/Race/Downtown/Ordered/dt_ordered_mb_01";
   var4.v804[2] = "game/Race/Downtown/Ordered/dt_ordered_ds_01";
   var4.v0.v4.v770 = 2;
   var4.v0.v4.v771 = 0;
   var4.v0.v4.v775 = var1;
   var4.v0.v4.v1[0 * 48].v0 = sub_62f(0);
   ...
   var4.v0.v4.v776 = 15;
   var4.v0.v4.v777 = 31;
   var4.v817 = "GREET_BESTOF_GH_22";
   var4.v818 = "TAUNT_PRE_BESTOF_GH_22";
   sub_764(&var4);
   Racer_SetStreamingUnlocked(var4.v0.v4.v1[1 * 48].v0);
}

function sub_62f(var0)
{
   auto var3, var4;
