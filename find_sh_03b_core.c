void main()
{
   ...
   var3.v1 = -3.767f;
   var3.v2 = 97.989f;
   mcTargetManager_RegisterLocation(607, &var3);
   mcTargetManager_HideTarget(607, 0);
   var6 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetElement(var6, 9, 607, &var3, (float)0);
   ...
   while (!var50)
   {
       ...
       if (var17 == 1)
       {
           mcTargetManager_HideTarget(607, 1);
           ...
           if (vhsmState_IsListener(var13) && (!Game_IsPaused()))
           {
               ...
               if ((!Game_IsPaused()) && (var14 < 20.0f))
               {
                   ...
                   else
                   {
                       ...
                       sub_660(var12, 0);
                       sub_660(var11, 1);
                       Warper_TransitionTo("STORY_LOCATION_CUT_SIMPLE", 607, &var25, &var28, &var31, "WarpFromCarToWaitPosition_CarneySign");
                       ...
                       mcEvent_PostEventStr("MISSION_EVENT", "FIND_SH_03B_OBJ_01_COMPLETE");
