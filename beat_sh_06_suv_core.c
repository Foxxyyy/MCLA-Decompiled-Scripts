void main()
{
   ...
   var4 = mcMissionManager_GetMission("BEAT_SH_06_SUV");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               {
                   sub_420(var12, "BEAT_SH_06_SUV_RESTRICTION", "VEHICLE_TYPE_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_539(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 31, 255, "BEAT_SH_06_SUV_RACE_COMPLETE", "GREET_BEAT_SH_06_SUV", "TAUNT_PRE_BEAT_SH_06_SUV");
