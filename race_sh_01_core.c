void main()
{
   ...
   mcHudMapServer_SetElement(var6, 9, var2, &var3, (float)0);
   mcHudMapServer_AddElement(var6);
   var7 = mcHookman_GetId(L[0].v0.v97.v0);
   ...
   OpponentManager_LoadOpponent(L[0].v0.v97.v1, mcHookman_GetCarConfigName(L[0].v0.v97.v0), &var8, 0);
   OpponentManager_AddOpponentToWorld(L[0].v0.v97.v1);
   var18 = Opponent_GetRacer(L[0].v0.v97.v1);
   Racer_SetUIDAndCharacterName(var18, var7, mcCareer_GetHookmanCharacterSet(mcHookman_GetName(L[0].v0.v97.v0)));
   Racer_SetModValue(var18, mcHookman_GetModValue(L[0].v0.v97.v0));
   mcTargetManager_RegisterLocation(var2, &var3);
   mcTargetManager_HideTarget(var2, 0);
   Racer_InitializeResetPosition(var18, &var8, var11);
   Racer_Reset(var18);
   var19 = sub_179(0);
   L[0].v0.v97.v2 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetVehicleElement(L[0].v0.v97.v2, 2, var18);
   Racer_SetIconType(var18, 4);
   var20 = mcCareer_GetDifficultyPlayerVsRacer(var18);
   ...
   var22 = null;
   var23 = mcMissionManager_GetMission("RACE_SH_01");
   var24 = 0.0f;
   var25 = 0;
   var26 = 0;
   var27 = 0;
   ...
   var30 = null;
   var31 = null;
   var32 = UIManager_GetState("Cruising_Offline");
   var33.v0 = -130.112f;
   var33.v1 = 18.506f;
   var33.v2 = -732.812f;
   var36.v0 = -130.681f;
   ...
   while (!var42)
   {
       Registry_GetValueInt("Script_SuspendAllOpponents", &var27);
       if (var27 == 1)
       {
       ...
       var25 = mcHookman_GetState(L[0].v0.v97.v0);
       if (var25 == 1)
       {
           while (var25 == 1)
           {
       ...
       if ((var25 == 4) || IsExitFlagSet())
       {
       }
       else
       {
           if (vhsmState_IsListener(var32) && (!Game_IsPaused()))
           {
               if ((var26 > 0) && (PoliceManager_CheckPoliceActivity(1) != 100))
               {
                   var26 = var26 - 1;
               }
               var24 = Racer_DistanceToPoint(var19, &var3);
               if ((!Game_IsPaused()) && (var24 < 30.0f))
               {
                   ...
                   {
                       mcRequirement_Satisfy(mcMission_GetObjective(var23, 0), 1);
                       mcRequirement_AlwaysHide(mcMission_GetObjective(var23, 1), 0);
                       mcHudMapServer_RemoveElement(var6);
                       mcHookman_SetState(L[0].v0.v97.v0, 1);
                       Racer_Deactivate(var19);
                       Warper_TransitionTo("STORY_LOCATION_CUT_SIMPLE", 600, &var33, &var36, &var39, "WarpFromCarToWaitPosition_CarneySign");
                       while (!Warper_IsReadyToLoadStuff())
                       {
                           WAITUNWARPED(100);
                           PRINTSTRING("Waiting For Camera To Get To Safe Spot\n");
                       }
                       PRINTSTRING("Camera is at a safe spot for starting the carney cutscene\n");
                       var28 = CityDescription_GetRaceIndexByName(var21, "game/Race/Hollywood/Ordered/hw_ordered_ds_02");
                       var22 = CityDescription_LookupRaceByIndex(var21, var28);
                       UIManager_SetCurrentMission(var23);
                       CineScript_SetGameCoordSysBinding(&var12);
                       sub_658(var19, 0);
                       sub_658(var18, 1);
                       PostProcessing_SetCutsceneDof();
                       var30 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_race_sh_01_generated", &null, 0, 1500);
                       while (!IsChildFinished(var30))
                       {
                           WAITUNWARPED(100);
                       }
                       ...
                       PRINTSTRING("Camera is at a safe spot for starting the booke race\n");
                       mcMission_ChangeState(var23, 3, 0);
                       Racer_Activate(var19);
                       mcHudMapServer_RemoveElement(var6);
                       mcHudMapServer_AddElement(L[0].v0.v97.v2);
                       sub_832(var7, var18, var19, var22, var28, L[0].v0.v97.v2);
                       mcHudMapServer_RemoveElement(L[0].v0.v97.v2);
                       if (mcMission_GetState(var23) == 5)
                       {
                           ...
                           CineScript_SetGameCoordSysBinding(&var12);
                           PostProcessing_SetCutsceneDof();
                           var30 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_rep_on_strip_garage_generated", &null, 0, 1500);
                           while (!IsChildFinished(var30))
                           {
                               WAITUNWARPED(100);
                           }
                       ...
                       {
                           mcRequirement_Satisfy(mcMission_GetObjective(var23, 0), 0);
                           mcRequirement_AlwaysHide(mcMission_GetObjective(var23, 1), 1);
                           mcEvent_PostEventStr("CAREER_AUTOSAVE", "");
                           Racer_InitializeResetPosition(var18, &var8, var11);
                           Racer_Reset(var18);
                           mcHudMapServer_AddElement(var6);
   ...
   PRINTSTRING("\n");
   Racer_HideIcon(var18, 1);
   mcTargetManager_UnRegisterTarget(var7);
   mcTargetManager_HideTarget(var2, 1);
   mcHudMapServer_DeleteElement(L[0].v0.v97.v2);
   mcHudMapServer_DeleteElement(var6);
   var31 = BrainFactory_CreateBrainCruising(var18);
   sub_27aa(RAND_INT_RANGE(0, 7), var31);
   BrainCruising_SetLooping(var31, 1);
   BrainCruising_DriveToNearestRail(var31);
...
void sub_832(var0, var1, var2, var3, var4, var5)
{
   auto var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22, var23, var24, var25, var26, var27, var28, var29, var30, var31, var32, var33, var34, var35, var36, var37, var38, var39, var40, var41, var42, var43, var44, var45, var46, var47, var48, var49, var50, var51, var52, var53, var54, var55, var56, var57, var58, var59, var60, var61, var62, var63, var64, var65, var66, var67, var68, var69, var70, var71, var72, var73, var74, var75, var76, var77, var78, var79, var80, var81, var82, var83, var84, var85, var86, var87, var88, var89, var90, var91, var92, var93, var94, var95, var96, var97, var98, var99, var100, var101, var102, var103, var104, var105, var106, var107, var108, var109, var110, var111, var112, var113, var114, var115, var116, var117, var118, var119, var120, var121, var122, var123, var124, var125, var126, var127, var128, var129, var130, var131, var132, var133, var134, var135, var136, var137, var138, var139, var140, var141, var142, var143, var144, var145, var146, var147, var148, var149, var150, var151, var152, var153, var154, var155, var156, var157, var158, var159, var160, var161, var162, var163, var164, var165, var166, var167, var168, var169, var170, var171, var172, var173, var174, var175, var176, var177, var178, var179, var180, var181, var182, var183, var184, var185, var186, var187, var188, var189, var190, var191, var192, var193, var194, var195, var196, var197, var198, var199, var200, var201, var202, var203, var204, var205, var206, var207, var208, var209, var210, var211, var212, var213, var214, var215, var216, var217, var218, var219, var220, var221, var222, var223, var224, var225, var226, var227, var228, var229, var230, var231, var232, var233, var234, var235, var236, var237, var238, var239, var240, var241, var242, var243, var244, var245, var246, var247, var248, var249, var250, var251, var252, var253, var254, var255, var256, var257, var258, var259, var260, var261, var262, var263, var264, var265, var266, var267, var268, var269, var270, var271, var272, var273, var274, var275, var276, var277, var278, var279, var280, var281, var282, var283, var284, var285, var286, var287, var288, var289, var290, var291, var292, var293, var294, var295, var296, var297, var298, var299, var300, var301, var302, var303, var304, var305, var306, var307, var308, var309, var310, var311, var312, var313, var314, var315, var316, var317, var318, var319, var320, var321, var322, var323, var324, var325, var326, var327, var328, var329, var330, var331, var332, var333, var334, var335, var336, var337, var338, var339, var340, var341, var342, var343, var344, var345, var346, var347, var348, var349, var350, var351, var352, var353, var354, var355, var356, var357, var358, var359, var360, var361, var362, var363, var364, var365, var366, var367, var368, var369, var370, var371, var372, var373, var374, var375, var376, var377, var378, var379, var380, var381, var382, var383, var384, var385, var386, var387, var388, var389, var390, var391, var392, var393, var394, var395, var396, var397, var398, var399, var400, var401, var402, var403, var404, var405, var406, var407, var408, var409, var410, var411, var412, var413, var414, var415, var416, var417, var418, var419, var420, var421, var422, var423, var424, var425, var426, var427, var428, var429, var430, var431, var432, var433, var434, var435, var436, var437, var438, var439, var440, var441, var442, var443, var444, var445, var446, var447, var448, var449, var450, var451, var452, var453, var454, var455, var456, var457, var458, var459, var460, var461, var462, var463, var464, var465, var466, var467, var468, var469, var470, var471, var472, var473, var474, var475, var476, var477, var478, var479, var480, var481, var482, var483, var484, var485, var486, var487, var488, var489, var490, var491, var492, var493, var494, var495, var496, var497, var498, var499, var500, var501, var502, var503, var504, var505, var506, var507, var508, var509, var510, var511, var512, var513, var514, var515, var516, var517, var518, var519, var520, var521, var522, var523, var524, var525, var526, var527, var528, var529, var530, var531, var532, var533, var534, var535, var536, var537, var538, var539, var540, var541, var542, var543, var544, var545, var546, var547, var548, var549, var550, var551, var552, var553, var554, var555, var556, var557, var558, var559, var560, var561, var562, var563, var564, var565, var566, var567, var568, var569, var570, var571, var572, var573, var574, var575, var576, var577, var578, var579, var580, var581, var582, var583, var584, var585, var586, var587, var588, var589, var590, var591, var592, var593, var594, var595, var596, var597, var598, var599, var600, var601, var602, var603, var604, var605, var606, var607, var608, var609, var610, var611, var612, var613, var614, var615, var616, var617, var618, var619, var620, var621, var622, var623, var624, var625, var626, var627, var628, var629, var630, var631, var632, var633, var634, var635, var636, var637, var638, var639, var640, var641, var642, var643, var644, var645, var646, var647, var648, var649, var650, var651, var652, var653, var654, var655, var656, var657, var658, var659, var660, var661, var662, var663, var664, var665, var666, var667, var668, var669, var670, var671, var672, var673, var674, var675, var676, var677, var678, var679, var680, var681, var682, var683, var684, var685, var686, var687, var688, var689, var690, var691, var692, var693, var694, var695, var696, var697, var698, var699, var700, var701, var702, var703, var704, var705, var706, var707, var708, var709, var710, var711, var712, var713, var714, var715, var716, var717, var718, var719, var720, var721, var722, var723, var724, var725, var726, var727, var728, var729, var730, var731, var732, var733, var734, var735, var736, var737, var738, var739, var740, var741, var742, var743, var744, var745, var746, var747, var748, var749, var750, var751, var752, var753, var754, var755, var756, var757, var758, var759, var760, var761, var762, var763, var764, var765, var766, var767, var768, var769, var770, var771, var772, var773, var774, var775, var776, var777, var778, var779, var780, var781, var782, var783, var784, var785, var786, var787, var788, var789, var790, var791, var792, var793, var794, var795, var796, var797, var798, var799, var800, var801, var802, var803, var804, var805, var806, var807, var808, var809, var810, var811, var812, var813, var814, var815, var816, var817, var818, var819, var820, var821, var822, var823, var824, var825, var826, var827, var828, var829, var830, var831, var832, var833, var834, var835, var836, var837;

   var8 = OpponentManager_FindFromUID(var0);
   var9.v4.v1 = 16;
   var9.v4.v1.v1.v9 = 15;
   var9.v4.v1.v1.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var9.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v791 = 3;
   var811 = 0;
   var815 = 0.0f;
   strcpy(&var816, 64, "");
   var9.v4.v1[0 * 48].v0 = var2;
   var9.v4.v1[0 * 48].v2 = 0;
   var9.v4.v1[0 * 48].v5 = 1;
   var9.v4.v1[1 * 48].v0 = var1;
   var9.v4.v1[1 * 48].v2 = 2;
   var9.v4.v1[1 * 48].v5 = 1;
   var9.v4.v1[1 * 48].v4 = var5;
   Racer_SetStreamingLockedIn(var1);
   var9.v4.v770 = 2;
   var9.v4.v771 = 0;
   var9.v4.v775 = mcCareer_GetDifficultyPlayerVsRacer(var1);
   var9.v4.v778 = 1;
   var9.v4.v780 = 0;
   var9.v4.v0 = var4;
   var9.v3 = Race_Create();
   Race_SetRaceData(var9.v3, &(var9.v4));
   Race_SetCurrentRace(var9.v3);
   Race_ToggleStarterCinematic(var9.v3, 1);
   var9.v4.v772 = RaceDescription_GetRaceType(var3);
   var9.v4.v773 = RaceDescription_GetRaceSubType(var3);
   var9.v4.v774 = 8;
   while (StringCompare(var9.v799, ""))
   {
       var9.v799 = "Game/RaceTypes/generic_countdown";
   }
   UILogic_SaveCarDamage();
   sub_cce(var3, 0.0f, 0, 0, 1, 1, 1);
   sub_129b(&var9);
   Race_GetRaceData(var9.v3, &(var9.v4));
   Registry_GetValueInt("raceOverTrigger", &var811);
   if (Race_IsDamagedOut(var9.v3))
   {
       Registry_GetValueInt("raceOverTrigger", &var811);
       while (var811 == 0)
       {
   ...
   else if (var811 == 0)
   {
       ...
       if (!var9.v4.v786)
       {
           mcEvent_PostEventRaceResults("GENERIC_RACE_COMPLETE", &(var9.v4));
           mcEvent_PostEventRaceResults("RACE_EVENT", &(var9.v4));
           mcEvent_PostEventStr("MISSION_EVENT", "RACE_SH_02_RACE_COMPLETE");
       }
       sub_164d(&var9, 0, 1, 1);
   ...
   PRINTSTRING("RACE_SH_01 Race command: ");
   PRINTSTRING(&var816);
   PRINTSTRING("\n");
   if (StringCaseCompare(&var816, "restart"))
   {
       PRINTSTRING("RACE_SH_01 race restart\n");
       sub_242b();
   }
   Racer_SetStreamingUnlocked(var1);
   Race_ResetCurrentRace();
   Race_Destroy(var9.v3);
   sub_1069();
}
...
function sub_b97(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_bd5(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_bd5(var0, var1, var2, var3, var4)
{
...
void sub_cce(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_164d(var0, var1, var2, var3)
{
