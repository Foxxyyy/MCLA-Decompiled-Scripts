void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("DISTRICT_CHAMPS_HILLS");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3d2(L[0].v0.v97.v1, mcHookman_GetDifficulty(L[0].v0.v97.v0));
   ...
   sub_856(RAND_INT_RANGE(0, 7), var7);
...
void sub_3d2(var0, var1)
{
   ...
   var4.v802 = "DISTRICT_CHAMPS_HILLS_SERIES";
   var4.v803 = 3;
   var4.v813 = 2;
   var4.v804[0] = "game/Race/Hills/Ordered/hl_ordered_ts_04";
   var4.v804[1] = "game/Race/Hills/Ordered/hl_ordered_jj_01";
   var4.v804[2] = "game/Race/Hills/Ordered/hl_ordered_mb_03";
   var4.v0.v4.v1[0 * 48].v0 = sub_60f(0);
