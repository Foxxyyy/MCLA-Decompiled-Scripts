void main()
{
   ...
   var2 = 8;
   var11 = 8;
   var11[0 * 3].v0 = 1527.98f;
   var11[0 * 3].v1 = -3.46512f;
   var11[0 * 3].v2 = -876.941f;
   var2[0] = "GREETING_FREEWAY_101";
   var11[1 * 3].v0 = 1693.66f;
   var11[1 * 3].v1 = 3.49308f;
   var11[1 * 3].v2 = -1051.19f;
   var2[1] = "GREETING_FREEWAY_HOPE";
   var11[2 * 3].v0 = 2512.21f;
   var11[2 * 3].v1 = -3.47984f;
   var11[2 * 3].v2 = -1054.39f;
   var2[2] = "GREETING_FREEWAY_5";
   var11[3 * 3].v0 = 2693.06f;
   var11[3 * 3].v1 = -3.62102f;
   var11[3 * 3].v2 = -578.849f;
   var2[3] = "GREETING_FREEWAY_2NDSTREET";
   var11[4 * 3].v0 = 2673.08f;
   var11[4 * 3].v1 = -4.37117f;
   var11[4 * 3].v2 = 3.86059f;
   var2[4] = "GREETING_FREEWAY_4TH";
   var11[5 * 3].v0 = 1739.93f;
   var11[5 * 3].v1 = 5.61775f;
   var11[5 * 3].v2 = 1073.88f;
   var2[5] = "GREETING_FREEWAY_10";
   var11[6 * 3].v0 = 1094.67f;
   var11[6 * 3].v1 = 2.33749f;
   var11[6 * 3].v2 = 795.906f;
   var2[6] = "GREETING_FREEWAY_110";
   var11[7 * 3].v0 = 1277.92f;
   var11[7 * 3].v1 = -5.00024f;
   var11[7 * 3].v2 = -194.867f;
   var2[7] = "GREETING_FREEWAY_4TH";
   var36.v0 = 31;
   var36.v95 = 90.0f;
   var36.v96 = 30.0f;
   var36.v100 = 0;
   var36.v97.v0 = mcCareer_FindAvailableHookman();
   mcHookman_SetId(var36.v97.v0, 303);
   mcHookman_SetType(var36.v97.v0, 5);
   mcHookman_SetName(var36.v97.v0, "GH_11");
   if (GetDemoCommandLine())
   {
       mcHookman_SetDifficulty(var36.v97.v0, 1);
   }
   else
   {
       mcHookman_SetDifficulty(var36.v97.v0, RAND_INT_RANGE(0, 3));
   }
   var36.v94 = 8;
   var139 = 0;
   while (var139 < var36.v94)
   {
       var36.v0[var139 * 3].v0 = var11[var139 * 3].v0;
       var36.v0[var139 * 3].v1 = var11[var139 * 3].v1;
       var36.v0[var139 * 3].v2 = var11[var139 * 3].v2;
       var139 = var139 + 1;
   }
   sub_2c8(&var36, &var2);
}

void sub_2c8(var0, var1)
{
...
void sub_ce6(var0, var1, var2, var3)
{
   ...
   *((var0 + 16) + 3096) = 5;
   ...
   Racer_GetPosition(var9, &var10);
   var13 = sub_e39(var10.v0, var10.v1, var10.v2, var1 + 0, *(var1 + 376));
   var14 = var13;
   var15 = var13;
   ...
   (*((var0 + 16) + 4))[1 * 48].v3 = sub_1200(*((var1 + 388) + 4));
...
function sub_e39(var0, var1, var2, var3, var4)
{
...
void sub_1a5e(var0, var1, var2, var3)
{
