void main()
{
   auto var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22;
   ...
   var4 = mcMissionManager_GetMission("BEAT_SH_04_BCLASS");
   var5 = 0;
   var7 = 0;
   var8 = 0;
   var9 = null;
   ...
   while (!var22)
   {
       ...
       else
       {
           ...
           var9 = START_NEW_SCRIPT_WITH_ARGS("game/CruisingHookmen/CruisingHookmanCore", &(L[0].v0), 103, 1500);
           while (!IsChildFinished(var9))
           {
               WAITUNWARPED(100);
           }
           var5 = mcHookman_GetState(L[0].v0.v97.v0);
           ...
           {
               var17 = sub_3a0(0);
               if (1 != Racer_GetPerformanceClass(var17))
               {
                   sub_435(var21, "BEAT_SH_04_BCLASS_RESTRICTION", "VEHICLE_CLASS_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_4f5(L[0].v0.v97.v1, L[0].v0.v97.v2, mcHookman_GetDifficulty(L[0].v0.v97.v0));
                       if (mcMission_GetState(var4) == 5)
                       {
                           sub_3464(1, 1, 0x3f800000, 0);
                           Racer_InitializeResetPosition(var17, &var18, 0.0f);
                           Racer_ResetWithDamageIntact(var17);
                           WAIT(0);
                           WAIT(0);
                           WAIT(0);
                           ...
                           var11.v2.v0.v2 = 0.0f;
                           var11.v2.v3 = 0.0f;
                           CineScript_SetGameCoordSysBinding(&var11);
                           sub_3c99(var17, 0);
                           sub_3c99(var3, 1);
                           PostProcessing_SetCutsceneDof();
                           var9 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_motorcycle_rep_generated", &null, 0, 1500);
                           while (!IsChildFinished(var9))
                           {
                               WAITUNWARPED(100);
                           }
   ...
   sub_3e3a(RAND_INT_RANGE(0, 15), var10);
...
function sub_435(var0, var1, var2, var3, var4)
{
...
void sub_4f5(var0, var1, var2)
{
   ...
   var6.v4.v778 = 1;
   var6.v4.v780 = 0;
   var829 = LookupCity(GetCurrentCity());
   var6.v4.v0 = CityDescription_GetRaceIndexByName(var829, "game/Race/Downtown/Ordered/dt_ordered_jp_02");
   var830 = CityDescription_LookupRaceByIndex(var829, var6.v4.v0);
   var6.v3 = Race_Create();
   Race_SetRaceData(var6.v3, &(var6.v4));
   Race_SetCurrentRace(var6.v3);
   sub_7d7(&var6, var830, var0, 2, 1, 13, "GREET_BEAT_SH_04_BCLASS");
   ...
   var6.v4.v772 = RaceDescription_GetRaceType(var830);
   var6.v4.v773 = RaceDescription_GetRaceSubType(var830);
   var6.v4.v774 = 8;
   CineScript_PrepareSpeechScenarioForNextCutscene("TAUNT_PRE_BEAT_SH_04_BCLASS", var6.v4.v1[0 * 48].v0, var5, 1);
   sub_2599(&var6);
   var6.v799 = sub_2647(var830, var6.v4.v770, 1);
   ...
   sub_285f(var830, 0.0f, 0, 0, 1, 1, 1);
   while (var824 == 0)
   {
       ...
       if (((!var6.v4.v786) && (!Race_IsDamagedOut(var6.v3))) && (!Race_HasBeenArrested(var6.v3)))
       {
           ...
           {
               mcEvent_PostEventStr("MISSION_EVENT", "BEAT_SH_04_BCLASS_RACE_COMPLETE");
           }
       }
       if (var6.v4.v1[0 * 48].v41 == 1)
       {
   ...
   strcpy(&var808, 64, "");
   Registry_GetValueString("raceOverCommand", &var808);
   PRINTSTRING("BEAT_SH_04_BCLASS Race command: ");
   PRINTSTRING(&var808);
   PRINTSTRING("\n");
   if (StringCaseCompare(&var808, "restart"))
   {
       PRINTSTRING("BEAT_SH_04_BCLASS race restart\n");
   ...
   {
       PRINTSTRING("BEAT_SH_04_BCLASS race replay\n");
...
void sub_7d7(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_88f(0, 0x3f000000, 108);
           sub_922(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_9d7(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_cff(var2);
...
function sub_922(var0, var1, var2, var3, var4)
{
...
void sub_1420(var0, var1, var2, var3)
{
...
function sub_2647(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2685(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2685(var0, var1, var2, var3, var4)
{
...
void sub_285f(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_3464(var0, var1, var2, var3)
{
...
void sub_37fb(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
