void main()
{
   ...
   var14.v1 = "cutscene/cut_la_hw_oh_garage_01x_ext";
   var14.v2 = "";
   CineScript_SetSceneName("cut_la_hw_oh_garage_01x_ext");
   CineScript_RequestPreraceTauntScenarioAudio("cut_la_hw_oh_garage_01x_ext");
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v3 = "cutscene/cut_la_hw_oh_garage_01x_ext/Entity/mover_drv00_car";
