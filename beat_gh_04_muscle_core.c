void main()
{
   ...
   var4 = null;
   var8 = mcMissionManager_GetMission("BEAT_GH_04_MUSCLE");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else if (!IsExitFlagSet())
           {
               Racer_SetStreamingLockedIn(var3);
               sub_3f8(L[0].v0.v97.v1, mcHookman_GetDifficulty(L[0].v0.v97.v0));
   ...
   var4 = BrainFactory_CreateBrainCruising(var3);
   sub_32b9(RAND_INT_RANGE(0, 7), var4);
...
void sub_3f8(var0, var1)
{
   ...
   var823 = 0;
   var827 = 0.0f;
   var5.v4.v1[0 * 48].v0 = sub_57e(0);
   var5.v4.v1[0 * 48].v2 = 0;
   var5.v4.v1[0 * 48].v5 = 1;
   var5.v4.v1[1 * 48].v0 = var4;
   ...
   var5.v4.v778 = 1;
   var5.v4.v780 = 0;
   var828 = mcRaceArray_Create();
   var829 = Racer_GetCurrentDistrict(var4);
   mcRaceArray_Fill(var828, 6, 2, 6);
   var5.v4.v0 = mcRaceArray_FindBeatMeThereRaceIndex(var828, var829, var4, 400.0f);
   var830 = LookupCity(GetCurrentCity());
   var831 = CityDescription_LookupRaceByIndex(var830, var5.v4.v0);
   var5.v4.v772 = RaceDescription_GetRaceType(var831);
   var5.v4.v773 = RaceDescription_GetRaceSubType(var831);
   var5.v4.v774 = 8;
   sub_6ed(&var5);
   var5.v799 = sub_79b(var831, var5.v4.v770, 1);
   ...
   sub_8ec(&var5, var831, var0, 2, 1, 13, 0);
   Registry_GetValueInt("raceOverTrigger", &var823);
   if (var823 == 1)
   {
       strcpy(&var807, 64, "");
       Registry_GetValueString("raceOverCommand", &var807);
       PRINTSTRING("Beat me there Race command: ");
       PRINTSTRING(&var807);
       PRINTSTRING("\n");
       if ((StringCaseCompare(&var807, "returnToCruise") || StringCaseCompare(&var807, "quit")) || StringCaseCompare(&var807, "returnToGarage"))
       {
       }
   }
   UILogic_SaveCarDamage();
   sub_265d(var831, 0.0f, 0, 0, 1, 1, 1);
   while ((var823 == 0) && (!Race_IsDamagedOut(var5.v3)))
   {
       UIManager_SendEvent("calculateResults");
       if (!var5.v4.v786)
       {
           mcCareer_UnlockRace(CityDescription_GetRaceNameByIndex(var830, var5.v4.v0));
           mcEvent_PostEventRaceResults("GENERIC_RACE_COMPLETE", &(var5.v4));
           mcEvent_PostEventRaceResults("RACE_EVENT", &(var5.v4));
       }
       if (var5.v4.v1[0 * 48].v41 == 1)
       {
           mcEvent_PostEventStr("MISSION_EVENT", "BEAT_GH_04_MUSCLE_RACE_COMPLETE");
       }
       sub_1535(&var5, 0, 1, 1);
   ...
   PRINTSTRING(&var807);
   PRINTSTRING("\n");
   if (StringCaseCompare(&var807, "restart"))
   {
...
function sub_79b(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_7d9(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_7d9(var0, var1, var2, var3, var4)
{
...
void sub_8ec(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_9a4(0, 0x3f000000, 108);
           sub_a37(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_aec(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_e14(var2);
...
function sub_a37(var0, var1, var2, var3, var4)
{
...
void sub_1535(var0, var1, var2, var3)
{
...
void sub_265d(var0, var1, var2, var3, var4, var5, var6)
{
