void main()
{
   ...
   var4 = mcMissionManager_GetMission("BEAT_SH_05_ACLASS");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           {
               var11 = sub_392(0);
               if (0 != Racer_GetPerformanceClass(var11))
               {
                   sub_427(var12, "BEAT_SH_05_ACLASS_RESTRICTION", "VEHICLE_CLASS_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_542(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "BEAT_SH_05_ACLASS_COMPLETE", "GREET_BEAT_SH_05_ACLASS", "TAUNT_PRE_BEAT_SH_05_ACLASS");
   ...
   sub_4386(RAND_INT_RANGE(0, 7), var10);
...
void sub_542(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11)
{
   ...
   sub_c89(&var14, var840, var0, 2, 1, 13, var10);
   var854 = 1;
   var855 = 0;
   var856 = 0;
   var857 = 0;
   ...
   sub_2b3f(&var14);
   var14.v799 = sub_2bf2(var840, var14.v4.v770, var854);
   ...
   {
       sub_2d42(var840, 0.0f, 0, 0, 1, 1, 1);
   }
   else
   {
       sub_2d42(var840, 0.25f, 0, 0, 1, 1, 1);
   }
   var856 = 0;
   if (var855)
   {
   ...
   {
       var853 = var852 + (var14.v4.v770 - var14.v4.v771);
       sub_4309(var14.v4.v1[0 * 48].v0, var14.v4.v1[var853 * 48].v1, var14.v4.v1[var853 * 48].v0, var853, Race_HasBeenArrested(var14.v3));
...
void sub_c89(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_d41(0, 0x3f000000, 108);
           sub_dd4(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_e89(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_11b1(var2);
...
function sub_dd4(var0, var1, var2, var3, var4)
{
...
void sub_18d2(var0, var1, var2, var3)
{
...
function sub_2bf2(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2c30(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2c30(var0, var1, var2, var3, var4)
{
...
void sub_2d42(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_3369(var0, var1, var2, var3)
{
...
void sub_3700(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_4309(var0, var1, var2, var3, var4)
{
