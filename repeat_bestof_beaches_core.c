void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("REPEAT_BESTOF_BEACHES");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3e7(L[0].v0.v97.v1, L[0].v0.v97.v2, mcHookman_GetDifficulty(L[0].v0.v97.v0), mcMission_GetHookmanNameId(var8));
   ...
   sub_885(RAND_INT_RANGE(0, 7), var7);
...
void sub_3e7(var0, var1, var2, var3)
{
   ...
   var6.v814 = 1;
   var6.v802 = "REPEAT_BESTOF_BE_SERIES";
   var6.v803 = 3;
   var6.v813 = 2;
   var6.v804[0] = "game/Race/Beaches/Circuit/be_circuit_mg_02";
   var6.v804[1] = "game/Race/Beaches/Ordered/be_ordered_jj_03";
   var6.v804[2] = "game/Race/Beaches/Ordered/be_ordered_ds_01";
   var6.v819 = var3;
   var6.v0.v4.v1[0 * 48].v0 = sub_634(0);
