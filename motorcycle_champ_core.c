void main()
{
   ...
   var4 = mcMissionManager_GetMission("MOTORCYCLE_CHAMP");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               {
                   sub_423(var12, "MOTORCYCLE_CHAMP_RESTRICTION", "VEHICLE_TYPE_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_53f(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "MOTO_CHAMP_OBJ_01_COMPLETE", "GREETING_MOTORCYCLE_CHAMP", "TAUNT_PRE_MOTORCYCLE_CHAMP");
                       if (mcMission_GetState(var4) == 5)
                       {
                           StatsManager_UpdateStatInt("aUMO", 0, 4, 1);
                       }
                       else
                       {
                           mcHookman_SetState(L[0].v0.v97.v0, 2);
   ...
   sub_4383(RAND_INT_RANGE(0, 7), var10);
...
function sub_423(var0, var1, var2, var3, var4)
{
...
void sub_53f(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11)
{
   ...
   sub_c86(&var14, var840, var0, 2, 1, 13, var10);
   var854 = 1;
   var855 = 0;
   var856 = 0;
   var857 = 0;
   ...
   sub_2b3c(&var14);
   var14.v799 = sub_2bef(var840, var14.v4.v770, var854);
   ...
   {
       sub_2d3f(var840, 0.0f, 0, 0, 1, 1, 1);
   }
   else
   {
       sub_2d3f(var840, 0.25f, 0, 0, 1, 1, 1);
   }
   var856 = 0;
   if (var855)
   {
   ...
   {
       var853 = var852 + (var14.v4.v770 - var14.v4.v771);
       sub_4306(var14.v4.v1[0 * 48].v0, var14.v4.v1[var853 * 48].v1, var14.v4.v1[var853 * 48].v0, var853, Race_HasBeenArrested(var14.v3));
...
void sub_c86(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_d3e(0, 0x3f000000, 108);
           sub_dd1(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_e86(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_11ae(var2);
...
function sub_dd1(var0, var1, var2, var3, var4)
{
...
void sub_18cf(var0, var1, var2, var3)
{
...
function sub_2bef(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2c2d(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2c2d(var0, var1, var2, var3, var4)
{
...
void sub_2d3f(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_3366(var0, var1, var2, var3)
{
...
void sub_36fd(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_4306(var0, var1, var2, var3, var4)
{
