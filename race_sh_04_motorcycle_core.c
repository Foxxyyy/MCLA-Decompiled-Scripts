void main()
{
   ...
   L[0].v0.v95 = 126.52f;
   L[0].v0.v100 = 0;
   L[0].v0.v0[0 * 3].v0 = -1064.81f;
   L[0].v0.v0[0 * 3].v1 = 29.8383f;
   L[0].v0.v0[0 * 3].v2 = -1906.64f;
   L[0].v0.v0[1 * 3].v0 = -505.931f;
   L[0].v0.v0[1 * 3].v1 = 66.8604f;
   L[0].v0.v0[1 * 3].v2 = -1461.96f;
   L[0].v0.v0[2 * 3].v0 = -288.576f;
   L[0].v0.v0[2 * 3].v1 = 84.8494f;
   L[0].v0.v0[2 * 3].v2 = -1627.76f;
   L[0].v0.v0[3 * 3].v0 = -300.357f;
   L[0].v0.v0[3 * 3].v1 = 93.5082f;
   L[0].v0.v0[3 * 3].v2 = -1201.63f;
   L[0].v0.v0[4 * 3].v0 = -990.529f;
   L[0].v0.v0[4 * 3].v1 = 73.2452f;
   L[0].v0.v0[4 * 3].v2 = -1441.56f;
   L[0].v0.v0[5 * 3].v0 = -726.006f;
   L[0].v0.v0[5 * 3].v1 = 74.3505f;
   L[0].v0.v0[5 * 3].v2 = -1528.52f;
   L[0].v0.v0[6 * 3].v0 = -1417.83f;
   L[0].v0.v0[6 * 3].v1 = 59.993f;
   L[0].v0.v0[6 * 3].v2 = -1696.56f;
   L[0].v0.v0[7 * 3].v0 = -1734.19f;
   L[0].v0.v0[7 * 3].v1 = 70.3518f;
   L[0].v0.v0[7 * 3].v2 = -1465.46f;
   L[0].v0.v0[8 * 3].v0 = -1823.34f;
   L[0].v0.v0[8 * 3].v1 = 47.5787f;
   L[0].v0.v0[8 * 3].v2 = -1911.56f;
   L[0].v0.v0[9 * 3].v0 = -2135.36f;
   L[0].v0.v0[9 * 3].v1 = 20.504f;
   L[0].v0.v0[9 * 3].v2 = -1785.32f;
   L[0].v0.v0[10 * 3].v0 = -1709.86f;
   L[0].v0.v0[10 * 3].v1 = 29.7865f;
   L[0].v0.v0[10 * 3].v2 = -1997.74f;
   ...
   var4 = mcMissionManager_GetMission("RACE_SH_04_MOTORCYCLE");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           {
               var11 = sub_4ec(0);
               if (!Racer_IsMotorcycle(var11))
               {
                   sub_583(var12, "BEAT_SH_04_MOTORCYCLE_RESTRICTION", "VEHICLE_TYPE_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_6ad(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "RACE_SH_04_MOTORCYCLE_COMPLETE", "GREETING_RACE_SH_04_MOTORCYCLE", "TAUNT_PRE_RACE_SH_04_MOTORCYCLE");
   ...
   sub_44f1(RAND_INT_RANGE(0, 7), var10);
...
function sub_583(var0, var1, var2, var3, var4)
{
...
void sub_6ad(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11)
{
   ...
   sub_df4(&var14, var840, var0, 2, 1, 13, var10);
   var854 = 1;
   var855 = 0;
   var856 = 0;
   var857 = 0;
   ...
   sub_2caa(&var14);
   var14.v799 = sub_2d5d(var840, var14.v4.v770, var854);
   ...
   {
       sub_2ead(var840, 0.0f, 0, 0, 1, 1, 1);
   }
   else
   {
       sub_2ead(var840, 0.25f, 0, 0, 1, 1, 1);
   }
   var856 = 0;
   if (var855)
   {
   ...
   {
       var853 = var852 + (var14.v4.v770 - var14.v4.v771);
       sub_4474(var14.v4.v1[0 * 48].v0, var14.v4.v1[var853 * 48].v1, var14.v4.v1[var853 * 48].v0, var853, Race_HasBeenArrested(var14.v3));
...
void sub_df4(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_eac(0, 0x3f000000, 108);
           sub_f3f(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_ff4(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_131c(var2);
...
function sub_f3f(var0, var1, var2, var3, var4)
{
...
void sub_1a3d(var0, var1, var2, var3)
{
...
function sub_2d5d(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2d9b(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2d9b(var0, var1, var2, var3, var4)
{
...
void sub_2ead(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_34d4(var0, var1, var2, var3)
{
...
void sub_386b(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_4474(var0, var1, var2, var3, var4)
{
