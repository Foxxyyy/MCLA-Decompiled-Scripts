void main()
{
   ...
   var14.v1 = "cutscene/racestart/gen_prerace_taunt_H_01";
   var14.v2 = "";
   CineScript_SetSceneName("racestart/gen_prerace_taunt_H_01");
   CineScript_RequestPreraceTauntScenarioAudio("racestart/gen_prerace_taunt_H_01");
