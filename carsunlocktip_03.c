void main()
{
   ...
   {
       PRINTSTRING("PLAYER HAS ENTERED THE GARAGE IGNORING TIP CarsUnlockTip_03\n");
   }
   ...
   {
       var6 = Sidekick_AppendData(5, "SIDEKICK_TITLE_TIP", 1, 6, 10.0f, "mec_mc_01_set", "Incoming Call!", "SIDEKICK_CARS_UNLOCK_TIP_03", "Prompt_NavigateToTutorialLog", 3, 0, "SIDEKICK_CARS_UNLOCK_TIP_03", "mec_mc_01_set", "PLAYER");
       var7 = 0;
       while ((!Sidekick_HasDataBeenAnnounced(var6)) && (!var7))
       {
           if (vhsmState_IsListener(var4))
           {
               PRINTSTRING("PLAYER HAS ENTERED THE GARAGE REMOVING TIP CarsUnlockTip_03\n");
               var7 = 1;
           }
           WAITUNWARPED(200);
       }
