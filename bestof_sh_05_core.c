void main()
{
   ...
   var3.v1 = -6.993f;
   var3.v2 = 284.309f;
   mcTargetManager_RegisterLocation(609, &var3);
   mcTargetManager_HideTarget(609, 0);
   var6 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetElement(var6, 9, 609, &var3, (float)0);
   ...
   var17 = Opponent_GetRacer(L[0].v0.v97.v1);
   Racer_SetUIDAndCharacterName(var17, var2, mcCareer_GetHookmanCharacterSet(mcHookman_GetName(L[0].v0.v97.v0)));
   Racer_SetModValue(var17, mcHookman_GetModValue(L[0].v0.v97.v0));
   Racer_SetVehicleDriverEnable(var17, 0);
   Racer_SetHeadlights(var17, 0);
   Racer_SetExhaust(var17, 0);
   Racer_InitializeResetPosition(var17, &var7, var10);
   Racer_Reset(var17);
   Racer_Deactivate(var17);
   var18 = sub_19d(0);
   L[0].v0.v97.v2 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetVehicleElement(L[0].v0.v97.v2, 10, var17);
   Racer_SetIconType(var17, 16);
   var19 = sub_216(var17);
   mcHookman_SetDifficulty(L[0].v0.v97.v0, var19);
   Racer_SetIconColorByDifficulty(var17, var19);
   Racer_HideIcon(var17, 1);
   var20 = mcMissionManager_GetMission("BESTOF_SH_05");
   var21 = UIManager_GetState("Cruising_Offline");
   var22 = 0.0f;
   var23 = 0;
   var24 = 0;
   var25 = 0;
   ...
   var57 = 18;
   var112 = 18;
   var57[0 * 3].v0 = 1353.21f;
   var57[0 * 3].v1 = -9.97f;
   var57[0 * 3].v2 = 266.883f;
   var112[0] = (float)-90;
   var57[1 * 3].v0 = 1337.084f;
   var57[1 * 3].v1 = -9.97f;
   var57[1 * 3].v2 = 272.275f;
   var112[1] = (float)1;
   var57[2 * 3].v0 = 1337.041f;
   var57[2 * 3].v1 = -9.97f;
   var57[2 * 3].v2 = 267.183f;
   var112[2] = (float)2;
   var57[3 * 3].v0 = 1337.162f;
   var57[3 * 3].v1 = -9.97f;
   var57[3 * 3].v2 = 262.045f;
   var112[3] = (float)0;
   var131 = 5;
   var137 = 5;
   var143 = 5;
   var149 = 5;
   var131[0] = "character/ped_mc_007_set";
   var137[0] = "ped_mc_007_set";
   var143[0] = "cutscene/hangout/cut_story_bestof_sh_05_peds";
   var149[0] = "m_ped00_loop";
   var131[1] = "character/ped_mc_006_set";
   var137[1] = "ped_mc_006_set";
   var143[1] = "cutscene/hangout/cut_story_bestof_sh_05_peds";
   var149[1] = "m_ped01_loop";
   var131[2] = "character/ped_mc_001_set";
   var137[2] = "ped_mc_001_set";
   var143[2] = "cutscene/hangout/cut_story_bestof_sh_05_peds";
   var149[2] = "m_ped02_loop";
   var131[3] = "character/ped_fc_003_set";
   var137[3] = "ped_fc_003_set";
   var143[3] = "cutscene/hangout/cut_story_bestof_sh_05_peds";
   var149[3] = "f_ped00_loop";
   var131[4] = "character/ped_fb_002_set";
   var137[4] = "ped_fb_002_set";
   var143[4] = "cutscene/hangout/cut_story_bestof_sh_05_peds";
   var149[4] = "f_ped01_loop";
   var155 = 0;
   while (!var155)
   {
       Registry_GetValueInt("Script_SuspendAllOpponents", &var25);
       if (var25 == 1)
       {
           mcHudMapServer_RemoveElement(var6);
           Racer_SetStreamingLockedOut(var17);
           while (var25 == 1)
           {
               Registry_GetValueInt("Script_SuspendAllOpponents", &var25);
               if (IsExitFlagSet())
           ...
           Racer_SetStreamingUnlocked(var17);
           var19 = sub_216(var17);
           mcHookman_SetDifficulty(L[0].v0.v97.v0, var19);
           Racer_SetIconColorByDifficulty(var17, var19);
           mcHudMapServer_AddElement(var6);
       }
       var23 = mcHookman_GetState(L[0].v0.v97.v0);
       if (var23 == 1)
       {
           while (var23 == 1)
           {
           ...
           while (var37 < 18)
           {
               var38[var37] = AmbientMgr_AddRandomCarToLayout(0, &(var57[var37 * 3]), var112[var37]);
               var37 = var37 + 1;
           }
       }
       if ((var23 == 4) || IsExitFlagSet())
       {
       }
       else
       {
           if (vhsmState_IsListener(var21) && (!Game_IsPaused()))
           {
               if ((var24 > 0) && (PoliceManager_CheckPoliceActivity(1) != 100))
               {
                   var24 = var24 - 1;
               }
               var22 = Racer_DistanceToPoint(var18, &var3);
               if ((!Game_IsPaused()) && (var22 < 30.0f))
               {
                   ...
                   {
                       mcRequirement_Satisfy(mcMission_GetObjective(var20, 0), 1);
                       mcRequirement_AlwaysHide(mcMission_GetObjective(var20, 1), 0);
                       mcRequirement_Hide(mcMission_GetObjective(var20, 1), 0);
                       mcHudMapServer_RemoveElement(var6);
                       ...
                       sub_92c(var18, 0);
                       sub_92c(var17, 1);
                       sub_9c3(5, &var131, &var137, &var143, &var149);
                       Warper_TransitionTo("STORY_LOCATION_CUT_SIMPLE", 609, &var27, &var30, &var33, "WarpFromCarToWaitPosition_CarneySign");
                       ...
                       Warper_SetIsWarpingToCutscene(1);
                       var36 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_bestof_sh_05_generated", &null, 0, 1500);
                       while (!IsChildFinished(var36))
                       {
                           WAITUNWARPED(100);
                       }
                       PostProcessing_SetGameDof();
                       sub_d53(&var143);
                       mcMission_ChangeState(var20, 3, 0);
                       Racer_Activate(var18);
                       mcHudMapServer_RemoveElement(var6);
                       mcHudMapServer_AddElement(L[0].v0.v97.v2);
                       Racer_SetVehicleDriverEnable(var17, 1);
                       Racer_SetExhaust(var17, 1);
                       sub_df0(L[0].v0.v97.v1, var18, mcHookman_GetDifficulty(L[0].v0.v97.v0));
                       mcHudMapServer_RemoveElement(L[0].v0.v97.v2);
                       var37 = 0;
                       while (var37 < 18)
                       {
                           AmbientMgr_RemoveAmbientFromLayout(var38[var37]);
                           var37 = var37 + 1;
                       }
                       if (mcMission_GetState(var20) == 5)
                       {
                           mcEvent_PostEventStr("CAREER_AUTOSAVE", "");
                       }
                       else
                       {
                           mcRequirement_Satisfy(mcMission_GetObjective(var20, 0), 0);
                           mcRequirement_AlwaysHide(mcMission_GetObjective(var20, 1), 1);
                           mcRequirement_Hide(mcMission_GetObjective(var20, 1), 1);
                           mcEvent_PostEventStr("CAREER_AUTOSAVE", "");
                           Racer_SetVehicleDriverEnable(var17, 0);
                           Racer_SetExhaust(var17, 0);
                           Racer_InitializeResetPosition(var17, &var7, var10);
   ...
   PRINTSTRING("\n");
   Racer_HideIcon(var17, 1);
   mcTargetManager_HideTarget(609, 1);
   mcTargetManager_UnRegisterTarget(var2);
   mcHudMapServer_DeleteElement(L[0].v0.v97.v2);
   mcHudMapServer_DeleteElement(var6);
   var26 = BrainFactory_CreateBrainCruising(var17);
   sub_137d(RAND_INT_RANGE(0, 7), var26);
   BrainCruising_SetLooping(var26, 1);
   BrainCruising_DriveToNearestRail(var26);
...
void sub_9c3(var0, var1, var2, var3, var4)
{
...
void sub_df0(var0, var1, var2)
{
   ...
   var5.v802 = "BESTOF_SH_05_SERIES";
   var5.v803 = 3;
   var5.v813 = 2;
   var5.v804[0] = "game/Race/Downtown/Ordered/dt_ordered_mb_02";
   var5.v804[1] = "game/Race/Downtown/Ordered/dt_ordered_ts_01";
   var5.v804[2] = "game/Race/Downtown/Ordered/dt_ordered_jp_02";
   var5.v0.v4.v770 = 2;
   var5.v0.v4.v771 = 0;
   ...
   var5.v0.v4.v776 = 15;
   var5.v0.v4.v777 = 31;
   var5.v817 = "GREET_BESTOF_SH_05";
   var5.v818 = "TAUNT_PRE_BESTOF_SH_05";
   sub_1145(&var5);
