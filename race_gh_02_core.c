void main()
{
   ...
   OpponentManager_LoadOpponent(L[37].v0.v97.v1, mcHookman_GetCarConfigName(L[37].v0.v97.v0), &(L[37].v0.v0[0 * 3]), 0);
   OpponentManager_AddOpponentToWorld(L[37].v0.v97.v1);
   var3 = Opponent_GetRacer(L[37].v0.v97.v1);
   Racer_SetUIDAndCharacterName(var3, var2, mcCareer_GetHookmanCharacterSet(mcHookman_GetName(L[37].v0.v97.v0)));
   Racer_SetModValue(var3, mcHookman_GetModValue(L[37].v0.v97.v0));
   mcTargetManager_RegisterRacer(var2, var3);
   L[37].v0.v94 = 12;
   L[37].v0.v95 = 133.95f;
   L[37].v0.v100 = 0;
   L[37].v0.v0[0 * 3].v0 = -34.8109f;
   L[37].v0.v0[0 * 3].v1 = 19.8368f;
   L[37].v0.v0[0 * 3].v2 = -800.355f;
   L[37].v0.v0[1 * 3].v0 = -220.152f;
   L[37].v0.v0[1 * 3].v1 = 19.8018f;
   L[37].v0.v0[1 * 3].v2 = -738.161f;
   L[37].v0.v0[2 * 3].v0 = -394.698f;
   L[37].v0.v0[2 * 3].v1 = 20.5541f;
   L[37].v0.v0[2 * 3].v2 = -694.69f;
   L[37].v0.v0[3 * 3].v0 = -461.608f;
   L[37].v0.v0[3 * 3].v1 = 20.0811f;
   L[37].v0.v0[3 * 3].v2 = -696.533f;
   L[37].v0.v0[4 * 3].v0 = -385.606f;
   L[37].v0.v0[4 * 3].v1 = 38.6172f;
   L[37].v0.v0[4 * 3].v2 = -853.801f;
   L[37].v0.v0[5 * 3].v0 = -328.621f;
   L[37].v0.v0[5 * 3].v1 = 30.4225f;
   L[37].v0.v0[5 * 3].v2 = -803.807f;
   L[37].v0.v0[6 * 3].v0 = -228.69f;
   L[37].v0.v0[6 * 3].v1 = 20.3864f;
   L[37].v0.v0[6 * 3].v2 = -728.341f;
   L[37].v0.v0[7 * 3].v0 = -19.2374f;
   L[37].v0.v0[7 * 3].v1 = 20.3564f;
   L[37].v0.v0[7 * 3].v2 = -802.16f;
   L[37].v0.v0[8 * 3].v0 = 164.117f;
   L[37].v0.v0[8 * 3].v1 = 23.7077f;
   L[37].v0.v0[8 * 3].v2 = -874.106f;
   L[37].v0.v0[9 * 3].v0 = 267.052f;
   L[37].v0.v0[9 * 3].v1 = 23.4986f;
   L[37].v0.v0[9 * 3].v2 = -809.016f;
   L[37].v0.v0[10 * 3].v0 = 180.422f;
   L[37].v0.v0[10 * 3].v1 = 17.0631f;
   L[37].v0.v0[10 * 3].v2 = -739.745f;
   L[37].v0.v0[11 * 3].v0 = 79.2074f;
   L[37].v0.v0[11 * 3].v1 = 18.9268f;
   L[37].v0.v0[11 * 3].v2 = -810.487f;
   var4.v0 = 268.76f;
   var4.v1 = 30.72f;
   var4.v2 = -1157.07f;
   Racer_InitializeResetPosition(var3, &var4, L[37].v0.v95);
   Racer_Reset(var3);
   L[37].v0.v97.v2 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetVehicleElement(L[37].v0.v97.v2, 2, var3);
   ...
   var11 = null;
   var12 = null;
   var13 = UIManager_GetState("GpsScene");
   var14 = 0;
   var15.v0 = 731.083f;
   var15.v1 = 8.539f;
   var15.v2 = -293.005f;
   ...
   var48 = 15;
   var94 = 15;
   var48[0 * 3].v0 = 758.611f;
   var48[0 * 3].v1 = 7.445f;
   var48[0 * 3].v2 = -317.641f;
   var94[0] = (float)-2;
   var48[1 * 3].v0 = 761.68f;
   var48[1 * 3].v1 = 7.445f;
   var48[1 * 3].v2 = -317.854f;
   var94[1] = (float)1;
   var48[2 * 3].v0 = 764.485f;
   var48[2 * 3].v1 = 7.445f;
   var48[2 * 3].v2 = -317.641f;
   var94[2] = (float)2;
   var48[3 * 3].v0 = 767.397f;
   var48[3 * 3].v1 = 7.445f;
   var48[3 * 3].v2 = -317.749f;
   var94[3] = (float)0;
   var48[4 * 3].v0 = 770.23f;
   var48[4 * 3].v1 = 7.445f;
   var48[4 * 3].v2 = -317.749f;
   var94[4] = -1.5f;
   var48[5 * 3].v0 = 773.192f;
   var48[5 * 3].v1 = 7.445f;
   var48[5 * 3].v2 = -317.641f;
   var94[5] = (float)0;
   var48[6 * 3].v0 = 776.104f;
   var48[6 * 3].v1 = 7.445f;
   var48[6 * 3].v2 = -317.906f;
   var94[6] = (float)2;
   var48[7 * 3].v0 = 778.936f;
   var48[7 * 3].v1 = 7.445f;
   var48[7 * 3].v2 = -318.011f;
   var94[7] = (float)0;
   var48[8 * 3].v0 = 758.472f;
   var48[8 * 3].v1 = 7.445f;
   var48[8 * 3].v2 = -304.607f;
   var94[8] = 177.123f;
   var48[9 * 3].v0 = 761.349f;
   var48[9 * 3].v1 = 7.445f;
   var48[9 * 3].v2 = -304.621f;
   var94[9] = 180.185f;
   var48[10 * 3].v0 = 764.404f;
   var48[10 * 3].v1 = 7.445f;
   var48[10 * 3].v2 = -304.607f;
   var94[10] = 177.123f;
   var48[11 * 3].v0 = 767.281f;
   var48[11 * 3].v1 = 7.445f;
   var48[11 * 3].v2 = -304.621f;
   var94[11] = 180.185f;
   var48[12 * 3].v0 = 769.799f;
   var48[12 * 3].v1 = 7.365f;
   var48[12 * 3].v2 = -285.91f;
   var94[12] = 179.756f;
   var48[13 * 3].v0 = 772.999f;
   var48[13 * 3].v1 = 7.365f;
   var48[13 * 3].v2 = -285.91f;
   var94[13] = 180.699f;
   var48[14 * 3].v0 = 776.041f;
   var48[14 * 3].v1 = 7.365f;
   var48[14 * 3].v2 = -285.91f;
   var94[14] = 181.658f;
   var110 = 4;
   var115 = 4;
   var120 = 4;
   var125 = 4;
   var110[0] = "character/ped_mb_002_set";
   var115[0] = "ped_mb_002_set";
   var120[0] = "cutscene/hangout/cut_story_rep_on_strip_garage_peds";
   var125[0] = "m_ped00_loop";
   var110[1] = "character/ped_m1_001_set";
   var115[1] = "ped_ma_001_set";
   var120[1] = "cutscene/hangout/cut_story_rep_on_strip_garage_peds";
   var125[1] = "m_ped01_loop";
   var110[2] = "character/ped_fh_001_set";
   var115[2] = "ped_fh_001_set";
   var120[2] = "cutscene/hangout/cut_story_rep_on_strip_garage_peds";
   var125[2] = "f_ped00_loop";
   var130 = 0;
   while (!var130)
   {
       var9 = mcHookman_GetState(L[37].v0.v97.v0);
       ...
       {
           var10 = mcCareer_GetDifficultyPlayerVsRacer(var3);
           mcHookman_SetDifficulty(L[37].v0.v97.v0, var10);
           Racer_SetIconColorByDifficulty(var3, var10);
           var11 = START_NEW_SCRIPT_WITH_ARGS("game/CruisingHookmen/CruisingHookmanCore", &(L[37].v0), 103, 1500);
           ...
           {
               L[37].v0.v101 = 1;
               sub_d2c(L[37].v0.v97.v1, L[37].v0.v97.v2, var7, mcHookman_GetDifficulty(L[37].v0.v97.v0));
   ...
   OpponentManager_RemoveOpponentFromWorld(L[37].v0.v97.v1);
   OpponentManager_DeleteOpponent(L[37].v0.v97.v1);
   mcSlotSystem_RequestSlotRemoval(L[37].v0.v97.v0, 0);
   mcSlotSystem_HideDistrict(0, 0);
   mcSlotSystem_UnlockDistrict(0, 0);
   sub_43fd();
   Registry_GetValueInt("NET_UNLOADCAREER", &var14);
   PRINTSTRING("UNLOAD CAREER = ");
   PRINTINT(var14);
   PRINTSTRING("\n");
   if ((((!GetNoTutorialCommandLine()) && (var14 < 1)) && (!Net_IsConnecting())) && (!Net_IsNetworked()))
   {
       Racer_Deactivate(var7);
       DYNAMICMIXER_TriggerState("DYNAMIC_MIXER_MUTE_SHENANIGANS");
       Warper_TransitionTo("STORY_LOCATION_CUT_SIMPLE", 500, &var15, &var18, &var21, "WarpFromCarToWaitPosition_CarneySign");
       ...
       while (var14 < 15)
       {
           var32[var14] = AmbientMgr_AddRandomCarToLayout(0, &(var48[var14 * 3]), var94[var14]);
           var14 = var14 + 1;
       }
       var30 = OpponentManager_CreateOpponent();
       OpponentManager_LoadOpponent(var30, "SH_01_0_vp_nsn_240sx_98", &(var24.v2.v0), var24.v2.v3);
       OpponentManager_AddOpponentToWorld(var30);
       var31 = Opponent_GetRacer(var30);
       Racer_SetCharacterName(var31, L[8]);
       Racer_SetStreamingLockedIn(var31);
       sub_46a0(var7, 0);
       sub_46a0(var31, 1);
       CineScript_SetGameCoordSysBinding(&var24);
       PostProcessing_SetCutsceneDof();
       var11 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_rep_on_strip_garage_generated", &null, 0, 1500);
       while (!IsChildFinished(var11))
       {
           WAITUNWARPED(100);
       }
       ...
       while (var14 < 15)
       {
           AmbientMgr_RemoveAmbientFromLayout(var32[var14]);
           var14 = var14 + 1;
       }
       OpponentManager_DeleteOpponent(var30);
       UILogic_PauseGame();
       DYNAMICMIXER_DeTriggerState("DYNAMIC_MIXER_MUTE_SHENANIGANS");
       while (vhsmState_IsActive(var13))
       {
           PRINTSTRING("WAITING TO LEAVE GPS\n");
           WAITUNWARPED(100);
       }
   }
   mcEvent_PostEventStr("CAREER_AUTOSAVE", "");
   Racer_Activate(var7);
   Racer_SetScrambleInputFlags(var7, 0);
   PRINTSTRING("Story Hookman -");
   PRINTINT(var2);
   PRINTSTRING(" deleted.\n");
}

function sub_5c8(var0)
{
   auto var3, var4;
...
void sub_d2c(var0, var1, var2, var3)
{
   ...
   var7.v4.v0 = CityDescription_GetRaceIndexByName(var830, "game/Race/Hollywood/Ordered/hw_ordered_ds_02");
   var831 = CityDescription_LookupRaceByIndex(var830, var7.v4.v0);
   var7.v3 = Race_Create();
   Race_SetRaceData(var7.v3, &(var7.v4));
   Race_SetCurrentRace(var7.v3);
   sub_ff2(&var7, var831, var0, 2, 1, 13, 0);
   ...
   if (var825 == 1)
   {
       ...
       PRINTSTRING(&var809);
       PRINTSTRING("\n");
       if ((StringCaseCompare(&var809, "returnToCruise") || StringCaseCompare(&var809, "quit")) || StringCaseCompare(&var809, "returnToGarage"))
       {
       }
   }
   var7.v4.v772 = RaceDescription_GetRaceType(var831);
   var7.v4.v773 = RaceDescription_GetRaceSubType(var831);
   var7.v4.v774 = 8;
   sub_2d7f(&var7);
   var7.v799 = sub_2e2d(var831, var7.v4.v770, 1);
   if (StringCompare(var7.v799, ""))
   {
       var7.v799 = "Game/RaceTypes/generic_countdown";
   }
   UILogic_SaveCarDamage();
   sub_2f64(var831, 0.0f, 0, 0, 1, 1, 1);
   while (var825 == 0)
   {
       if (((!var7.v4.v786) && (!Race_IsDamagedOut(var7.v3))) && (!Race_HasBeenArrested(var7.v3)))
       {
           ...
           mcEvent_PostEventStr("MISSION_EVENT", "RACE_GH_02_RACE_COMPLETE");
       }
       if (Race_IsDamagedOut(var7.v3) || var7.v4.v786)
       {
           sub_1c3b(&var7, 0, 0, 1);
   ...
   strcpy(&var809, 64, "");
   Registry_GetValueString("raceOverCommand", &var809);
   PRINTSTRING("RACE_GH_02 Race command: ");
   PRINTSTRING(&var809);
   PRINTSTRING("\n");
   if (StringCaseCompare(&var809, "restart"))
   {
       PRINTSTRING("RACE_GH_02 race restart\n");
   ...
   {
       PRINTSTRING("RACE_GH_02 race replay\n");
       Registry_SetValueInt("replaying", 1);
       sub_3b59(1, 1, 0x3f800000, 0);
       Warper_Warp("REPLAY");
   ...
   Racer_SetStreamingUnlocked(var6);
   Race_ResetCurrentRace();
   Race_Destroy(var7.v3);
   sub_32ff();
}

void sub_ff2(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_10aa(0, 0x3f000000, 108);
           sub_113d(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_11f2(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_151a(var2);
...
function sub_113d(var0, var1, var2, var3, var4)
{
...
void sub_1c3b(var0, var1, var2, var3)
{
...
function sub_2e2d(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2e6b(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2e6b(var0, var1, var2, var3, var4)
{
...
void sub_2f64(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_3b59(var0, var1, var2, var3)
{
...
void sub_3ef0(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
