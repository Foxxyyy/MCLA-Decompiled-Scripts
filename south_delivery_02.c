void main()
{
   ...
   var2 = 16;
   var2[0 * 3].v0 = 821.006f;
   var2[0 * 3].v1 = 17.4904f;
   var2[0 * 3].v2 = -806.928f;
   var2[1 * 3].v0 = 824.802f;
   var2[1 * 3].v1 = 17.4904f;
   var2[1 * 3].v2 = -804.513f;
   var2[2 * 3].v0 = 829.365f;
   var2[2 * 3].v1 = 17.4904f;
   var2[2 * 3].v2 = -811.684f;
   var2[3 * 3].v0 = 825.568f;
   var2[3 * 3].v1 = 17.4904f;
   var2[3 * 3].v2 = -814.1f;
   var2[4 * 3].v0 = 833.927f;
   var2[4 * 3].v1 = 17.4904f;
   var2[4 * 3].v2 = -818.856f;
   var2[5 * 3].v0 = 830.131f;
   var2[5 * 3].v1 = 17.4904f;
   var2[5 * 3].v2 = -821.271f;
   var2[6 * 3].v0 = 838.758f;
   var2[6 * 3].v1 = 17.4904f;
   var2[6 * 3].v2 = -826.45f;
   var2[7 * 3].v0 = 834.961f;
   var2[7 * 3].v1 = 17.4904f;
   var2[7 * 3].v2 = -828.865f;
   var2[8 * 3].v0 = 843.052f;
   var2[8 * 3].v1 = 17.4904f;
   var2[8 * 3].v2 = -833.2f;
   var2[9 * 3].v0 = 839.255f;
   var2[9 * 3].v1 = 17.4904f;
   var2[9 * 3].v2 = -835.615f;
   var2[10 * 3].v0 = 847.615f;
   var2[10 * 3].v1 = 17.4904f;
   var2[10 * 3].v2 = -840.371f;
   var2[11 * 3].v0 = 843.818f;
   var2[11 * 3].v1 = 17.4904f;
   var2[11 * 3].v2 = -842.787f;
   var2[12 * 3].v0 = 852.177f;
   var2[12 * 3].v1 = 17.4904f;
   var2[12 * 3].v2 = -847.543f;
   var2[13 * 3].v0 = 848.38f;
   var2[13 * 3].v1 = 17.4904f;
   var2[13 * 3].v2 = -849.958f;
   var2[14 * 3].v0 = 856.74f;
   var2[14 * 3].v1 = 17.4904f;
   var2[14 * 3].v2 = -854.715f;
   var2[15 * 3].v0 = 852.943f;
   var2[15 * 3].v1 = 17.4904f;
   var2[15 * 3].v2 = -857.13f;
   var51 = 16;
   var51[0] = 147.537f;
   var51[1] = 147.537f;
   var51[2] = 147.537f;
   ...
   var51[15] = 147.537f;
   var68 = 1;
   var68[0 * 3].v0 = -2794.06f;
   var68[0 * 3].v1 = -21.7801f;
   var68[0 * 3].v2 = 896.573f;
   var72 = 1;
   var72[0] = 22.5f;
   var74 = 1;
   var74[0] = (float)20;
   ...
   sub_8ae(&L[0], "Delivery_vp_lam_murcielago_06");
   TriggerManager_DestroyTriggerArray(var92);
}

void sub_8ae(var0, var1)
{
