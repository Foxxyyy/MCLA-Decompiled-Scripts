void main()
{
   ...
   var5 = null;
   var6 = 0;
   var8 = mcMissionManager_GetMission("BESTOF_GH_27");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3fe(L[0].v0.v97.v1, var3, var4);
...
void sub_3fe(var0, var1, var2)
{
   ...
   var5.v814 = 1;
   var5.v802 = "BESTOF_GH_27_SERIES";
   var5.v803 = 3;
   var5.v813 = 2;
   var5.v804[0] = "game/Race/SouthCentral/Circuit/sc_circuit_dh_01";
   var5.v804[1] = "game/Race/SouthCentral/Ordered/sc_ordered_mb_02";
   var5.v804[2] = "game/Race/SouthCentral/Circuit/sc_circuit_cb_03b";
   ...
   var5.v0.v4.v776 = 31;
   var5.v0.v4.v777 = 255;
   var5.v817 = "GREETING_BEAT_ME_THERE";
   var5.v818 = "TAUNT_PRE_BESTOF_GH_27";
   sub_760(&var5);
