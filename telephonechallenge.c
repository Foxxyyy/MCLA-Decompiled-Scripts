void main()
{
   ...
   var11[3] = 20;
   var11[4] = 26;
   var17 = UIManager_GetState("Cruising_Offline");
   Registry_GetValueInt("telephone_challenge_state", &var2);
   if (var2 != 0)
   {
   }
   else
   {
       Registry_SetValueInt("telephone_challenge_state", 3);
       while (!vhsmState_IsListener(var17))
       {
           WAITUNWARPED(100);
       }
       var3 = RAND_INT_RANGE(2000, 2500);
       while (!IsExitFlagSet())
       {
           if (((((vhsmState_IsListener(var17) && (!Game_IsPaused())) && (PoliceManager_CheckPoliceActivity(1) < 2)) && (!Player_IsInIdleCam(0))) && (!mcUINavMap_IsTargetSelected())) && (!UILogic_IsCameraPaused()))
           {
               var3 = var3 - 1;
               if (var3 < 0)
               {
                   var4 = RAND_INT_RANGE(0, 4);
                   sub_193(var5[var4], var11[var4]);
               }
           }
           WAITUNWARPED(100);
       }
       WAITUNWARPED(10);
       Registry_SetValueInt("telephone_challenge_state", 0);
   }
}

void sub_193(var0, var1)
{
   auto var4, var5, var6, var7, var8, var9, var10, var11, var12, var13;

   var4 = 0;
   Registry_SetValueInt("nTelephoneMenuResult", var4);
   var5 = null;
   var6 = 0;
   var7 = UIManager_GetState("Cruising_Offline");
   var8 = HUD_GetHUDCtrl(12);
   var9 = Form_GetForm(89);
   var10 = mcCareer_GetHookmanCharacterSet(var0);
   var11 = Sidekick_AppendData(3, "TelephoneChallenge", var1, 1, 4.0f, var10, "Incoming Call", "Lets Race", "Back To Accept", 0, 0, "HOOKMAN_PHONE_INVITE_PLAYER", var10, "PLAYER");
   while ((!Sidekick_IsDataBeingAnnounced(var11)) || UIManager_IsDisplayingMenu())
   {
       if (Sidekick_HasDataBeenAnnounced(var11))
       {
           return;
       }
       else
   ...
   if (((var9 != null) && (!GetNoTutorialCommandLine())) && (StatsManager_GetIntValue("tTCH", 0) == 0))
   {
       Form_ShowForm(Form_GetForm(-1), var9);
       StatsManager_UpdateStatInt("tTCH", 0, 3, 1);
   }
   while (!Sidekick_IsDataDirty(var11))
   {
       WAITUNWARPED(100);
   }
   if ((var9 != null) && Form_GetFormVisible(var9))
   {
       Form_CloseForm(var9);
   }
   var6 = 50;
   while (Sidekick_SidekickIsWaitForScriptFlagSet())
   {
       ...
       {
           if ((vhsmState_IsListener(var7) && (!Game_IsPaused())) && (!Player_IsInIdleCam(0)))
           {
               var6 = var6 - 1;
               if ((var6 < 0) && Sidekick_SidekickIsWaitForScriptFlagSet())
               {
                   Sidekick_IgnoreSelect(1);
                   PropertyCtrl_SetPropertyString(var8, 3, "");
                   var5 = mcCareerSpeech_FindScenario("HOOKMAN_PHONE_PLAYER_DECLINES");
                   if (var5 != null)
                   {
                       mcCareerSpeech_PlayScenario(var5, var10, "PLAYER");
                       while (mcCareerSpeech_IsScenarioPlaying(var5))
                       {
                           PRINTSTRING("WAITING FOR SCENARIO TO STOP\n");
                           if (PoliceManager_CheckPoliceActivity(1) > 1)
                           {
                               return;
                           }
                   ...
                   Sidekick_SidekickToggleWaitForScriptFlag(0);
               }
           }
           WAITUNWARPED(100);
       }
   }
   if (UILogic_GetIsTelephoneChallenge())
   {
       while (var4 == 0)
       {
           Registry_GetValueInt("nTelephoneMenuResult", &var4);
           WAITUNWARPED(100);
       }
       if (var4 == 3)
       {
           var5 = mcCareerSpeech_FindScenario("GREETING_MEET_ME_THERE_EVENT");
           if (var5 != null)
           {
               mcCareerSpeech_PlayScenario(var5, var10, "PLAYER");
           }
           PRINTSTRING("STARTING CHALLENGE RACE\n");
           sub_52b(var0);
       }
       else
       {
...
void sub_52b(var0)
{
   ...
   var5.v4.v1 = 16;
   var5.v4.v1.v1.v9 = 15;
   var5.v4.v1.v1.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25 = 15;
   var5.v4.v1.v1.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v9.v25.v48.v791 = 3;
   var807 = 0;
   strcpy(&var808, 64, "");
   var824 = 0.0f;
   var825.v0 = 0.0f;
   ...
   var825.v2 = 0.0f;
   var828 = null;
   Registry_GetValueInt("nRaceIndex", &(var5.v4.v0));
   var5.v4.v1[0 * 48].v0 = sub_6ef(0);
   var5.v4.v1[0 * 48].v2 = 0;
   var5.v4.v1[0 * 48].v5 = 1;
   var5.v4.v1[1 * 48].v1 = OpponentManager_CreateOpponent();
   var5.v4.v1[1 * 48].v0 = Opponent_GetRacer(var5.v4.v1[1 * 48].v1);
   var5.v4.v1[1 * 48].v2 = 2;
   var5.v4.v1[1 * 48].v5 = 1;
   var5.v4.v1[1 * 48].v4 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetVehicleElement(var5.v4.v1[1 * 48].v4, 6, var5.v4.v1[1 * 48].v0);
   mcHudMapServer_AddElement(var5.v4.v1[1 * 48].v4);
   Registry_GetValueInt("nDifficulty", &(var5.v4.v775));
   var829 = OpponentManager_FindCharacterConfigData(var0);
   var830 = mcCharacterConfigData_GetCarConfigData(var829, Racer_GetCarConfig(var5.v4.v1[0 * 48].v0), var5.v4.v775, 255, 1);
   var831 = mcCarConfigData_GetRandomConfigData(var830);
   OpponentManager_LoadOpponent(var5.v4.v1[1 * 48].v1, mcConfigData_GetName(var831), &var825, 0);
   OpponentManager_AddOpponentToWorld(var5.v4.v1[1 * 48].v1);
   Racer_SetCharacterName(var5.v4.v1[1 * 48].v0, mcCareer_GetHookmanCharacterSet(var0));
   Racer_SetModValue(var5.v4.v1[1 * 48].v0, mcCarConfigData_GetModValue(var830));
   Racer_SetStreamingLockedIn(var5.v4.v1[1 * 48].v0);
   var4 = CityDescription_LookupRaceByIndex(var3, var5.v4.v0);
   var5.v4.v772 = RaceDescription_GetRaceType(var4);
   var5.v4.v773 = RaceDescription_GetRaceSubType(var4);
   var5.v4.v774 = 15;
   var5.v4.v770 = 2;
   var5.v4.v771 = 0;
   if (var5.v4.v775 < 2)
   ...
   var5.v4.v780 = 0;
   sub_967(&var5);
   var5.v799 = sub_a12(var4, var5.v4.v770, 1);
   if (StringCompare(var5.v799, ""))
   {
       var5.v799 = "Game/RaceTypes/generic_countdown";
   }
   sub_b3f(var4, 0.25f, 0, 0, 1, 1, 1);
   Registry_GetValueInt("nNumLaps", &(var5.v4.v779));
   var5.v3 = Race_Create();
   Race_SetRaceData(var5.v3, &(var5.v4));
   Race_SetCurrentRace(var5.v3);
   UILogic_SaveCarDamage();
   while (var807 == 0)
   {
       UIManager_SendEvent("calculateResults");
       if (((!var5.v4.v786) && (!Race_IsDamagedOut(var5.v3))) && (!Race_HasBeenArrested(var5.v3)))
       {
           mcEvent_PostEventRaceResults("GENERIC_RACE_COMPLETE", &(var5.v4));
           mcEvent_PostEventRaceResults("RACE_EVENT", &(var5.v4));
       }
       sub_148d(&var5, 0, 1, 1);
       UIManager_SendEvent("raceEnd");
       while (var807 == 0)
       {
           Registry_GetValueInt("raceOverTrigger", &var807);
           WAITUNWARPED(20);
       }
       AudioManager_SetActiveEndRace(0, 0);
   }
   Registry_GetValueString("raceOverCommand", &var808);
   PRINTSTRING("RaceWrapper decision made :");
   PRINTSTRING(&var808);
   PRINTSTRING("\n");
   if (StringCaseCompare(&var808, "restart"))
   {
       PRINTSTRING("Telephone race restart\n");
   ...
   else if (StringCaseCompare(&var808, "replay"))
   {
       PRINTSTRING("Telephone race replay\n");
       RaceDescription_GetGridPosition(var4, 0, &var825, &var824);
       sub_23fd(1, 1, 0x3f800000, 0);
       Warper_TransitionTo("REPLAY", -1, &var825, &var825, &var825, "");
       ...
       sub_27a4(1, 1, 0x3f800000, 0);
       Warper_TransitionTo("EXIT_TO_CUT", -1, &var825, &var825, &var825, "");
   ...
   else if (StringCaseCompare(&var808, "quit"))
   {
       mcCareerSpeech_PlayTauntpostRace(var5.v4.v1[1 * 48].v0, var5.v4.v1[0 * 48].v0, 0);
   }
   sub_2bdb(var5.v4.v1[0 * 48].v0, var5.v4.v1[1 * 48].v1, var5.v4.v1[1 * 48].v0, RAND_INT_RANGE(0, 7), Race_HasBeenArrested(var5.v3));
   Racer_HideIcon(var5.v4.v1[1 * 48].v0, 1);
   mcHudMapServer_DeleteElement(var5.v4.v1[1 * 48].v4);
   Race_ResetCurrentRace();
   Race_Destroy(var5.v3);
}

function sub_6ef(var0)
{
   auto var3, var4;
...
function sub_a12(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_a50(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_a50(var0, var1, var2, var3, var4)
{
...
void sub_b3f(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_148d(var0, var1, var2, var3)
{
...
void sub_23fd(var0, var1, var2, var3)
{
...
void sub_27a4(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_2bdb(var0, var1, var2, var3, var4)
{
