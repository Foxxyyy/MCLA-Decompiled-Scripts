void main()
{
   ...
   var4 = null;
   var8 = mcMissionManager_GetMission("BEAT_GH_04_TUNER");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else if (!IsExitFlagSet())
           {
               ...
               sub_3f7(L[0].v0.v97.v1, mcHookman_GetDifficulty(L[0].v0.v97.v0));
   ...
   sub_32b7(RAND_INT_RANGE(0, 7), var4);
...
void sub_3f7(var0, var1)
{
   ...
   var5.v4.v774 = 8;
   sub_6ec(&var5);
   var5.v799 = sub_79a(var831, var5.v4.v770, 1);
   ...
   sub_8eb(&var5, var831, var0, 2, 1, 13, 0);
   ...
   sub_265c(var831, 0.0f, 0, 0, 1, 1, 1);
   while ((var823 == 0) && (!Race_IsDamagedOut(var5.v3)))
   {
       ...
       {
           mcEvent_PostEventStr("MISSION_EVENT", "BEAT_TUNER_GH_05_RACE_COMPLETE");
       }
       sub_1534(&var5, 0, 1, 1);
...
function sub_79a(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_7d8(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_7d8(var0, var1, var2, var3, var4)
{
...
void sub_8eb(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_9a3(0, 0x3f000000, 108);
           sub_a36(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_aeb(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_e13(var2);
...
function sub_a36(var0, var1, var2, var3, var4)
{
...
void sub_1534(var0, var1, var2, var3)
{
...
void sub_265c(var0, var1, var2, var3, var4, var5, var6)
{
