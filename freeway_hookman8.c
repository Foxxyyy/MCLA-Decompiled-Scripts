void main()
{
   ...
   var2 = 9;
   var12 = 9;
   var12[0 * 3].v0 = -225.947f;
   var12[0 * 3].v1 = -3.94085f;
   var12[0 * 3].v2 = 650.95f;
   var2[0] = "GREETING_FREEWAY_LACIENEGA_SC";
   var12[1 * 3].v0 = 931.621f;
   var12[1 * 3].v1 = (float)0;
   var12[1 * 3].v2 = 653.393f;
   var2[1] = "GREETING_FREEWAY_110";
   var12[2 * 3].v0 = 1071.81f;
   var12[2 * 3].v1 = -10.2316f;
   var12[2 * 3].v2 = 1509.06f;
   var2[2] = "GREETING_FREEWAY_39_STREET_SC";
   var12[3 * 3].v0 = 532.748f;
   var12[3 * 3].v1 = -15.161f;
   var12[3 * 3].v2 = 1895.26f;
   var2[3] = "GREETING_FREEWAY_110";
   var12[4 * 3].v0 = -337.216f;
   var12[4 * 3].v1 = -16.6407f;
   var12[4 * 3].v2 = 1849.66f;
   var2[4] = "GREETING_FREEWAY_CRENSHAW_SC";
   var12[5 * 3].v0 = -1511.99f;
   var12[5 * 3].v1 = -15.3979f;
   var12[5 * 3].v2 = 1661.37f;
   var2[5] = "GREETING_FREEWAY_LACIENEGA_SC";
   var12[6 * 3].v0 = -1893.6f;
   var12[6 * 3].v1 = -8.71643f;
   var12[6 * 3].v2 = 860.708f;
   var2[6] = "GREETING_FREEWAY_10";
   var12[7 * 3].v0 = -1524.01f;
   var12[7 * 3].v1 = -2.41087f;
   var12[7 * 3].v2 = 750.613f;
   var2[7] = "GREETING_FREEWAY_AVESTARS";
   var12[8 * 3].v0 = -975.256f;
   var12[8 * 3].v1 = -4.60862f;
   var12[8 * 3].v2 = 675.874f;
   var2[8] = "GREETING_FREEWAY_CRENSHAW_SC";
   var40.v0 = 31;
   var40.v95 = 270.0f;
   var40.v96 = 30.0f;
   var40.v100 = 0;
   var40.v97.v0 = mcCareer_FindAvailableHookman();
   mcHookman_SetId(var40.v97.v0, 307);
   mcHookman_SetType(var40.v97.v0, 5);
   mcHookman_SetName(var40.v97.v0, "GH_32");
...
void sub_d20(var0, var1, var2, var3)
{
   ...
   *((var0 + 16) + 3096) = 5;
   ...
   Racer_GetPosition(var9, &var10);
   var13 = sub_e73(var10.v0, var10.v1, var10.v2, var1 + 0, *(var1 + 376));
   var14 = var13;
   var15 = var13;
   ...
   (*((var0 + 16) + 4))[1 * 48].v3 = sub_123a(*((var1 + 388) + 4));
...
function sub_e73(var0, var1, var2, var3, var4)
{
...
void sub_1a98(var0, var1, var2, var3)
{
