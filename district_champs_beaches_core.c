void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("DISTRICT_CHAMPS_BEACHES");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3d4(L[0].v0.v97.v1, mcHookman_GetDifficulty(L[0].v0.v97.v0));
   ...
   sub_860(RAND_INT_RANGE(0, 7), var7);
...
void sub_3d4(var0, var1)
{
   ...
   var4.v802 = "DISTRICT_CHAMPS_BEACHES_SERIES";
   var4.v803 = 3;
   var4.v813 = 2;
   var4.v804[0] = "game/Race/Beaches/Ordered/be_ordered_mb_04";
   var4.v804[1] = "game/Race/Beaches/Ordered/be_ordered_mb_01";
   var4.v804[2] = "game/Race/Beaches/Ordered/be_ordered_mg_02";
   var4.v0.v4.v1[0 * 48].v0 = sub_619(0);
