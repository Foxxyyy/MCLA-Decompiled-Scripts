void main()
{
   ...
   var2 = 16;
   var19 = 16;
   var19[0 * 3].v0 = 1175.05f;
   var19[0 * 3].v1 = 23.125f;
   var19[0 * 3].v2 = -1312.88f;
   var2[0] = "GREETING_FREEWAY_HIGHLAND";
   var19[1 * 3].v0 = 544.624f;
   var19[1 * 3].v1 = 23.5448f;
   var19[1 * 3].v2 = -2276.95f;
   var2[1] = "GREETING_FREEWAY_MULHOLLAND";
   var19[2 * 3].v0 = -442.273f;
   var19[2 * 3].v1 = 38.6313f;
   var19[2 * 3].v2 = -2024.25f;
   var2[2] = "GREETING_FREEWAY_LAURELCANYON";
   var19[3 * 3].v0 = -1133.85f;
   var19[3 * 3].v1 = 37.9014f;
   var19[3 * 3].v2 = -2218.86f;
   var2[3] = "GREETING_FREEWAY_SEPULVEDA";
   var19[4 * 3].v0 = -1978.86f;
   var19[4 * 3].v1 = 30.8021f;
   var19[4 * 3].v2 = -2018.62f;
   var2[4] = "GREETING_FREEWAY_405";
   var19[5 * 3].v0 = -2043.34f;
   var19[5 * 3].v1 = 12.3199f;
   var19[5 * 3].v2 = -1312.72f;
   var2[5] = "GREETING_FREEWAY_SUNSET";
   var19[6 * 3].v0 = -2180.32f;
   var19[6 * 3].v1 = 13.6841f;
   var19[6 * 3].v2 = -608.744f;
   var2[6] = "GREETING_FREEWAY_WILSHIRE";
   var19[7 * 3].v0 = -2204.82f;
   var19[7 * 3].v1 = 6.02952f;
   var19[7 * 3].v2 = -16.0964f;
   var2[7] = "GREETING_FREEWAY_SANTAMONICA";
   var19[8 * 3].v0 = -2061.93f;
   var19[8 * 3].v1 = 7.45f;
   var19[8 * 3].v2 = 556.878f;
   var2[8] = "GREETING_FREEWAY_10";
   var19[9 * 3].v0 = -1523.24f;
   var19[9 * 3].v1 = -2.83415f;
   var19[9 * 3].v2 = 749.228f;
   var2[9] = "GREETING_FREEWAY_AVESTARS";
   var19[10 * 3].v0 = -976.348f;
   var19[10 * 3].v1 = -4.91865f;
   var19[10 * 3].v2 = 676.192f;
   var2[10] = "GREETING_FREEWAY_CRENSHAW";
   var19[11 * 3].v0 = -200.405f;
   var19[11 * 3].v1 = -4.01199f;
   var19[11 * 3].v2 = 660.204f;
   var2[11] = "GREETING_FREEWAY_LACIENEGA";
   var19[12 * 3].v0 = 953.94f;
   var19[12 * 3].v1 = 0.048767f;
   var19[12 * 3].v2 = 636.972f;
   var2[12] = "GREETING_FREEWAY_110";
   var19[13 * 3].v0 = 1097.21f;
   var19[13 * 3].v1 = -7.33131f;
   var19[13 * 3].v2 = 326.534f;
   var2[13] = "GREETING_FREEWAY_WILSHIRE";
   var19[14 * 3].v0 = 1213.5f;
   var19[14 * 3].v1 = -7.67137f;
   var19[14 * 3].v2 = -92.8054f;
   var2[14] = "GREETING_FREEWAY_3RDSTREET";
   var19[15 * 3].v0 = 1511.54f;
   var19[15 * 3].v1 = -5.26569f;
   var19[15 * 3].v2 = -927.44f;
   var2[15] = "GREETING_FREEWAY_110";
   var68.v0 = 31;
   var68.v95 = 90.0f;
   var68.v96 = 30.0f;
   var68.v100 = 0;
   var68.v97.v0 = mcCareer_FindAvailableHookman();
   mcHookman_SetId(var68.v97.v0, 305);
   mcHookman_SetType(var68.v97.v0, 5);
   mcHookman_SetName(var68.v97.v0, "GH_24");
...
void sub_ea3(var0, var1, var2, var3)
{
   ...
   *((var0 + 16) + 3096) = 5;
   ...
   Racer_GetPosition(var9, &var10);
   var13 = sub_ff6(var10.v0, var10.v1, var10.v2, var1 + 0, *(var1 + 376));
   var14 = var13;
   var15 = var13;
   ...
   (*((var0 + 16) + 4))[1 * 48].v3 = sub_13bd(*((var1 + 388) + 4));
...
function sub_ff6(var0, var1, var2, var3, var4)
{
...
void sub_1c1b(var0, var1, var2, var3)
{
