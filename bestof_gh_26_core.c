void main()
{
   ...
   var5 = null;
   var6 = 0;
   var8 = mcMissionManager_GetMission("BESTOF_GH_26");
   var9 = 0;
   while (!var9)
   {
...
void sub_3fe(var0, var1, var2)
{
   ...
   var5.v814 = 1;
   var5.v802 = "BESTOF_GH_26_SERIES";
   var5.v803 = 3;
   var5.v813 = 2;
   var5.v804[0] = "game/Race/SouthCentral/Circuit/sc_circuit_jp_01";
   var5.v804[1] = "game/Race/SouthCentral/Ordered/sc_ordered_dh_01";
   var5.v804[2] = "game/Race/SouthCentral/Ordered/sc_ordered_ds_01b";
   ...
   var5.v818 = "TAUNT_PRE_BESTOF_GH_26";
   sub_760(&var5);
