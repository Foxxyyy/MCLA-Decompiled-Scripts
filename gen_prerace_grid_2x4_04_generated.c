void main()
{
   ...
   var14.v1 = "cutscene/racestart/gen_prerace_grid_2x4_04";
   var14.v2 = "";
   CineScript_SetSceneName("racestart/gen_prerace_grid_2x4_04");
   CineScript_RequestPreraceTauntScenarioAudio("racestart/gen_prerace_grid_2x4_04");
