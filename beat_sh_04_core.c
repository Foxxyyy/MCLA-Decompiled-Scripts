void main()
{
   ...
   var4 = mcMissionManager_GetMission("BEAT_SH_04");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var11)
   {
       ...
       else
       {
           ...
           {
               L[0].v0.v101 = 1;
               sub_3cd(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "BEAT_SH_04_RACE_COMPLETE", 0, 0);
   ...
   sub_424c(RAND_INT_RANGE(0, 7), var10);
...
void sub_3cd(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11)
{
   ...
   sub_b4f(&var14, var840, var0, 2, 1, 13, var10);
   var854 = 1;
   var855 = 0;
   var856 = 0;
   var857 = 0;
   ...
   sub_2a05(&var14);
   var14.v799 = sub_2ab8(var840, var14.v4.v770, var854);
   ...
   {
       sub_2c08(var840, 0.0f, 0, 0, 1, 1, 1);
   }
   else
   {
       sub_2c08(var840, 0.25f, 0, 0, 1, 1, 1);
   }
   var856 = 0;
   if (var855)
   {
   ...
   {
       var853 = var852 + (var14.v4.v770 - var14.v4.v771);
       sub_41cf(var14.v4.v1[0 * 48].v0, var14.v4.v1[var853 * 48].v1, var14.v4.v1[var853 * 48].v0, var853, Race_HasBeenArrested(var14.v3));
...
void sub_b4f(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_c07(0, 0x3f000000, 108);
           sub_c9a(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_d4f(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_1077(var2);
...
function sub_c9a(var0, var1, var2, var3, var4)
{
...
void sub_1798(var0, var1, var2, var3)
{
...
function sub_2ab8(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_2af6(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_2af6(var0, var1, var2, var3, var4)
{
...
void sub_2c08(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_322f(var0, var1, var2, var3)
{
...
void sub_35c6(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_41cf(var0, var1, var2, var3, var4)
{
