void main()
{
   ...
   var14.v1 = "cutscene/cut_la_be_smb_garage_01x_ent";
   var14.v2 = "";
   CineScript_SetSceneName("cut_la_be_smb_garage_01x_ent");
   CineScript_RequestPreraceTauntScenarioAudio("cut_la_be_smb_garage_01x_ent");
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v0 = "mover_garage_car";
       var14.v127[0 * 5].v2 = 1;
       var14.v127[0 * 5].v4 = "mover_garage_car";
       var14.v127[0 * 5].v3 = "cutscene/cut_la_be_smb_garage_01x_ent/Entity/mover_garage_car";
