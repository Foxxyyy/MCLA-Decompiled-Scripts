void main()
{
   ...
   var14.v1 = "cutscene/cut_reward_gen_01";
   var14.v2 = "";
   CineScript_SetSceneName("cut_reward_gen_01");
   CineScript_RequestPreraceTauntScenarioAudio("cut_reward_gen_01");
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v3 = "cutscene/cut_reward_gen_01/Entity/mover_player_car";
   ...
   if (var344 != null)
   {
       ...
       var14.v127[1 * 5].v3 = "cutscene/cut_reward_gen_01/Entity/mover_hookman_car";
