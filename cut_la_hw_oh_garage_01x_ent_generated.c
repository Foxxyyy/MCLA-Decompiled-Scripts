void main()
{
   ...
   var14.v1 = "cutscene/cut_la_hw_oh_garage_01x_ent";
   var14.v2 = "";
   CineScript_SetSceneName("cut_la_hw_oh_garage_01x_ent");
   CineScript_RequestPreraceTauntScenarioAudio("cut_la_hw_oh_garage_01x_ent");
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v0 = "mover_playergarage_car";
       var14.v127[0 * 5].v2 = 1;
       var14.v127[0 * 5].v4 = "mover_playergarage_car";
       var14.v127[0 * 5].v3 = "cutscene/cut_la_hw_oh_garage_01x_ent/Entity/mover_playergarage_car";
       var3[0] = Racer_GetStreamLockState(var344);
       Racer_SetStreamingLockedIn(var344);
   }
   var14.v126 = 1;
   var14.v179[0 * 7].v0 = "fade_to_black";
   var14.v179[0 * 7].v1 = 0;
   var14.v179[0 * 7].v2 = "";
   var14.v179[0 * 7].v3 = -1;
   var14.v179[0 * 7].v4 = 0.166667f;
   var14.v179[0 * 7].v5 = 0.0f;
   var14.v179[0 * 7].v6 = 0.0f;
   var14.v179[1 * 7].v0 = "cam_to_garage";
   var14.v179[1 * 7].v1 = 0;
   var14.v179[1 * 7].v2 = "";
   var14.v179[1 * 7].v3 = -1;
   ...
   var14.v179[2 * 7].v0 = "garage_lighting";
   var14.v179[2 * 7].v1 = 0;
   var14.v179[2 * 7].v2 = "";
   var14.v179[2 * 7].v3 = -1;
