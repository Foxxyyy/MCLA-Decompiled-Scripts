void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("REPEAT_BESTOF_DOWNTOWN");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3e8(L[0].v0.v97.v1, L[0].v0.v97.v2, mcHookman_GetDifficulty(L[0].v0.v97.v0), mcMission_GetHookmanNameId(var8));
   ...
   sub_889(RAND_INT_RANGE(0, 7), var7);
...
void sub_3e8(var0, var1, var2, var3)
{
   ...
   var6.v814 = 1;
   var6.v802 = "REPEAT_BESTOF_DT_SERIES";
   var6.v803 = 3;
   var6.v813 = 2;
   var6.v804[0] = "game/Race/Downtown/Ordered/dt_ordered_mb_03";
   var6.v804[1] = "game/Race/Downtown/Circuit/dt_circuit_as_02";
   var6.v804[2] = "game/Race/Downtown/Ordered/dt_ordered_jp_01";
   var6.v819 = var3;
   var6.v0.v4.v1[0 * 48].v0 = sub_638(0);
