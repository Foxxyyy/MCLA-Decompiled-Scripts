void main()
{
   ...
   var2 = 16;
   var2[0 * 3].v0 = 821.019f;
   var2[0 * 3].v1 = 17.4924f;
   var2[0 * 3].v2 = -806.963f;
   var2[1 * 3].v0 = 824.69f;
   var2[1 * 3].v1 = 17.4924f;
   var2[1 * 3].v2 = -804.361f;
   var2[2 * 3].v0 = 829.606f;
   var2[2 * 3].v1 = 17.4924f;
   var2[2 * 3].v2 = -811.296f;
   var2[3 * 3].v0 = 825.934f;
   var2[3 * 3].v1 = 17.4924f;
   var2[3 * 3].v2 = -813.898f;
   var2[4 * 3].v0 = 834.521f;
   var2[4 * 3].v1 = 17.4924f;
   var2[4 * 3].v2 = -818.231f;
   var2[5 * 3].v0 = 830.849f;
   var2[5 * 3].v1 = 17.4924f;
   var2[5 * 3].v2 = -820.833f;
   var2[6 * 3].v0 = 839.725f;
   var2[6 * 3].v1 = 17.4924f;
   var2[6 * 3].v2 = -825.573f;
   var2[7 * 3].v0 = 836.054f;
   var2[7 * 3].v1 = 17.4924f;
   var2[7 * 3].v2 = -828.176f;
   var2[8 * 3].v0 = 844.351f;
   var2[8 * 3].v1 = 17.4924f;
   var2[8 * 3].v2 = -832.1f;
   var2[9 * 3].v0 = 840.68f;
   var2[9 * 3].v1 = 17.4924f;
   var2[9 * 3].v2 = -834.702f;
   var2[10 * 3].v0 = 849.266f;
   var2[10 * 3].v1 = 17.4924f;
   var2[10 * 3].v2 = -839.035f;
   var2[11 * 3].v0 = 845.595f;
   var2[11 * 3].v1 = 17.4924f;
   var2[11 * 3].v2 = -841.637f;
   var2[12 * 3].v0 = 854.182f;
   var2[12 * 3].v1 = 17.4924f;
   var2[12 * 3].v2 = -845.97f;
   var2[13 * 3].v0 = 850.51f;
   var2[13 * 3].v1 = 17.4924f;
   var2[13 * 3].v2 = -848.572f;
   var2[14 * 3].v0 = 859.097f;
   var2[14 * 3].v1 = 17.4924f;
   var2[14 * 3].v2 = -852.905f;
   var2[15 * 3].v0 = 855.426f;
   var2[15 * 3].v1 = 17.4924f;
   var2[15 * 3].v2 = -855.507f;
   var51 = 16;
   var51[0] = 144.672f;
   var51[1] = 144.672f;
   var51[2] = 144.672f;
   ...
   var51[15] = 144.672f;
   var68 = 1;
   var68[0 * 3].v0 = 27.5923f;
   var68[0 * 3].v1 = 96.2397f;
   var68[0 * 3].v2 = -1679.64f;
   var72 = 1;
   var72[0] = 11.5f;
   var74 = 1;
   var74[0] = (float)20;
   ...
   sub_8a3(&L[0], "Delivery_vp_sln_s281_06");
