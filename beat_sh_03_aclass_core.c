void main()
{
   ...
   var4 = mcMissionManager_GetMission("BEAT_SH_03_ACLASS");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               {
                   sub_427(var12, "BEAT_SH_03_ACLASS_RESTRICTION", "VEHICLE_CLASS_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_547(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "BEAT_SH_03_ACLASS_RACE_COMPLETE", "GREET_BEAT_SH_03_ACLASS", "TAUNT_PRE_BEAT_SH_03_ACLASS");
