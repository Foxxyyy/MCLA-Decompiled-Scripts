void main()
{
   ...
   var5 = 0;
   var7 = null;
   var8 = mcMissionManager_GetMission("REPEAT_BESTOF_HILLS");
   var9 = 0;
   while (!var9)
   {
       ...
       else
       {
           ...
           else
           {
               ...
               sub_3e5(L[0].v0.v97.v1, L[0].v0.v97.v2, mcHookman_GetDifficulty(L[0].v0.v97.v0), mcMission_GetHookmanNameId(var8));
   ...
   sub_87d(RAND_INT_RANGE(0, 7), var7);
...
void sub_3e5(var0, var1, var2, var3)
{
   ...
   var6.v814 = 1;
   var6.v802 = "REPEAT_BESTOF_HL_SERIES";
   var6.v803 = 3;
   var6.v813 = 2;
   var6.v804[0] = "game/Race/Hills/Ordered/hl_ordered_ts_04";
   var6.v804[1] = "game/Race/Hills/Ordered/hl_ordered_jj_01";
   var6.v804[2] = "game/Race/Hills/Circuit/hl_circuit_jj_02";
   var6.v819 = var3;
   var6.v0.v4.v1[0 * 48].v0 = sub_62c(0);
