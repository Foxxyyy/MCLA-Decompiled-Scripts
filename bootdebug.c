void main()
{
   ...
   var2 = 0;
   var3 = GetRaceNameCommandLine(&var2);
   var4 = 0;
   var5 = GetMissionCommandLine(&var4);
   if (!(var2 == 0))
   {
       ...
       var7.v4.v0 = CityDescription_GetRaceIndexByName(var6, var3);
       var7.v4.v779 = GetNumLapsCommandLine();
       var7.v4.v782 = GetPowerUpsCommandLine() != 0;
       var7.v4.v775 = GetOpponentDifficultyCommandLine();
       var7.v4.v771 = GetNumOpponentCommandLine();
       var7.v4.v778 = GetLayoutmodeCommandLine();
       START_NEW_SCRIPT_WITH_ARGS("Game/Race/RaceWrapper", &var7, 802, 3800);
   }
   else if (!(var4 == 0))
   {
       var809 = mcMissionManager_GetMission(var5);
       if (var809 != null)
       {
           mcMission_Start(var809, 0);
       }
   }
   var810 = 0;
   var811 = GetScriptCommandLine(&var810);
   if (!(var810 == 0))
   {
       START_NEW_SCRIPT_WITH_ARGS(var811, &null, 0, 3800);
   }
   var812 = 0;
   while (!var812)
   {
       var812 = IsExitFlagSet();
       WAITUNWARPED(2000);
   }
}
