void main()
{
   ...
   var4 = mcMissionManager_GetMission("EXOTIC_CHAMP");
   var5 = 0;
   var6 = 0;
   var7 = 0;
   var8 = 0;
   ...
   while (!var13)
   {
       ...
       else
       {
           ...
           {
               var11 = sub_38d(0);
               if (Racer_GetVehicleClass(var11) != 2)
               {
                   sub_41c(var12, "EXOTIC_CHAMP_RESTRICTION", "VEHICLE_TYPE_RESTRICTION", 1, 1);
                   mcHookman_SetState(L[0].v0.v97.v0, 2);
               }
               else
               {
                   ...
                   {
                       L[0].v0.v101 = 1;
                       sub_532(L[0].v0.v97.v1, 0, mcHookman_GetDifficulty(L[0].v0.v97.v0), L[0].v0.v97.v2, 8, 2, 6, 15, 31, "EXOTIC_CHAMP_OBJ_01_COMPLETE", "GREETING_EXOTIC_CHAMP", "TAUNT_PRE_EXOTIC_CHAMP");
                       if (mcMission_GetState(var4) == 5)
                       {
                           StatsManager_UpdateStatInt("aUEX", 0, 4, 1);
                       }
                       else
                       {
                           mcHookman_SetState(L[0].v0.v97.v0, 2);
